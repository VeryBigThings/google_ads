defmodule Google.Ads.Googleads.V19.Common.Metrics do
  ...
  field :general_invalid_click_rate, 370, type: :double, json_name: "generalInvalidClickRate"
  field :general_invalid_clicks, 371, type: :int64, json_name: "generalInvalidClicks"
  ...
  field :linked_entities_count, 341, type: :int64, json_name: "linkedEntitiesCount"
  ...
  field :asset_pinned_total_count, 348, type: :int64, json_name: "assetPinnedTotalCount"
  ...
  field :results_conversions_purchase, 366, type: :double, json_name: "resultsConversionsPurchase"
  field :video_view_rate_in_feed, 367, type: :double, json_name: "videoViewRateInFeed"
  field :video_view_rate_in_stream, 368, type: :double, json_name: "videoViewRateInStream"
  field :video_view_rate_shorts, 369, type: :double, json_name: "videoViewRateShorts"
end
