defmodule Google.Ads.Googleads.V19.Common.Segments do
  ...
  field :activity_city, 185, type: :string, json_name: "activityCity"
  field :activity_country, 186, type: :string, json_name: "activityCountry"
  field :activity_rating, 149, type: :int64, json_name: "activityRating"
  field :activity_state, 187, type: :string, json_name: "activityState"
  ...
  field :ad_group, 158, type: :string, json_name: "adGroup"
  field :asset_group, 159, type: :string, json_name: "assetGroup"
  ...
  field :campaign, 157, type: :string
  ...
  field :product_category_level1, 161, type: :string, json_name: "productCategoryLevel1"
  field :product_category_level2, 162, type: :string, json_name: "productCategoryLevel2"
  field :product_category_level3, 163, type: :string, json_name: "productCategoryLevel3"
  field :product_category_level4, 164, type: :string, json_name: "productCategoryLevel4"
  field :product_category_level5, 165, type: :string, json_name: "productCategoryLevel5"
  ...
  field :travel_destination_city, 193, type: :string, json_name: "travelDestinationCity"
  field :travel_destination_country, 194, type: :string, json_name: "travelDestinationCountry"
  field :travel_destination_region, 195, type: :string, json_name: "travelDestinationRegion"
  ...
  field :search_subcategory, 155, type: :string, json_name: "searchSubcategory"
  field :search_term, 156, type: :string, json_name: "searchTerm"
  ...
  field :sk_ad_network_source_domain, 152, type: :string, json_name: "skAdNetworkSourceDomain"
  ...
  field :sk_ad_network_version, 192, type: :string, json_name: "skAdNetworkVersion"
