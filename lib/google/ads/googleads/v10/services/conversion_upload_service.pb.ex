defmodule Google.Ads.Googleads.V10.Services.UploadClickConversionsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          conversions: [Google.Ads.Googleads.V10.Services.ClickConversion.t()],
...
defmodule Google.Ads.Googleads.V10.Services.UploadClickConversionsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.ClickConversionResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.UploadCallConversionsRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          conversions: [Google.Ads.Googleads.V10.Services.CallConversion.t()],
          partial_failure: boolean,
          validate_only: boolean
        }
...
defmodule Google.Ads.Googleads.V10.Services.UploadCallConversionsResponse do
  ...
  @type t :: %__MODULE__{
          partial_failure_error: Google.Rpc.Status.t() | nil,
          results: [Google.Ads.Googleads.V10.Services.CallConversionResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.ClickConversion do
  ...
  @type t :: %__MODULE__{
          ...
          external_attribution_data:
            Google.Ads.Googleads.V10.Services.ExternalAttributionData.t() | nil,
          custom_variables: [Google.Ads.Googleads.V10.Services.CustomVariable.t()],
          cart_data: Google.Ads.Googleads.V10.Services.CartData.t() | nil,
          user_identifiers: [Google.Ads.Googleads.V10.Common.UserIdentifier.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.CartData do
  ...
  @type t :: %__MODULE__{
          ...
          items: [Google.Ads.Googleads.V10.Services.CartData.Item.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.ConversionUploadService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.ConversionUploadService"
