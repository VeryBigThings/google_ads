defmodule Google.Ads.Googleads.V10.Resources.CampaignBudget do
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V10.Enums.BudgetStatusEnum.BudgetStatus.t(),
          delivery_method:
            Google.Ads.Googleads.V10.Enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod.t(),
          explicitly_shared: boolean,
          reference_count: integer,
          has_recommended_budget: boolean,
          recommended_budget_amount_micros: integer,
          period: Google.Ads.Googleads.V10.Enums.BudgetPeriodEnum.BudgetPeriod.t(),
          ...
          type: Google.Ads.Googleads.V10.Enums.BudgetTypeEnum.BudgetType.t()
        }
