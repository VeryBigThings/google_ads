defmodule Google.Ads.Googleads.V10.Resources.ConversionAction.AttributionModelSettings do
  ...
  @type t :: %__MODULE__{
          attribution_model:
            Google.Ads.Googleads.V10.Enums.AttributionModelEnum.AttributionModel.t(),
          data_driven_model_status:
            Google.Ads.Googleads.V10.Enums.DataDrivenModelStatusEnum.DataDrivenModelStatus.t()
        }
...
defmodule Google.Ads.Googleads.V10.Resources.ConversionAction do
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          status:
            Google.Ads.Googleads.V10.Enums.ConversionActionStatusEnum.ConversionActionStatus.t(),
          type: Google.Ads.Googleads.V10.Enums.ConversionActionTypeEnum.ConversionActionType.t(),
          ...
          value_settings:
            Google.Ads.Googleads.V10.Resources.ConversionAction.ValueSettings.t() | nil,
          counting_type:
            Google.Ads.Googleads.V10.Enums.ConversionActionCountingTypeEnum.ConversionActionCountingType.t(),
          attribution_model_settings:
            Google.Ads.Googleads.V10.Resources.ConversionAction.AttributionModelSettings.t() | nil,
          tag_snippets: [Google.Ads.Googleads.V10.Common.TagSnippet.t()],
          phone_call_duration_seconds: integer,
          app_id: String.t(),
          mobile_app_vendor:
            Google.Ads.Googleads.V10.Enums.MobileAppVendorEnum.MobileAppVendor.t(),
          firebase_settings:
            Google.Ads.Googleads.V10.Resources.ConversionAction.FirebaseSettings.t() | nil,
          third_party_app_analytics_settings:
            Google.Ads.Googleads.V10.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings.t()
            | nil
        }
