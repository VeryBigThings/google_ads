defmodule Google.Ads.Googleads.V10.Resources.FeedItemTarget do
  ...
  @type t :: %__MODULE__{
          ...
          feed_item_target_type:
            Google.Ads.Googleads.V10.Enums.FeedItemTargetTypeEnum.FeedItemTargetType.t(),
          feed_item_target_id: integer,
          status: Google.Ads.Googleads.V10.Enums.FeedItemTargetStatusEnum.FeedItemTargetStatus.t()
        }
