...
defmodule Google.Ads.Googleads.V10.Resources.AdGroup do
  ...
  @type t :: %__MODULE__{
          ...
          id: integer,
          name: String.t(),
          status: Google.Ads.Googleads.V10.Enums.AdGroupStatusEnum.AdGroupStatus.t(),
          type: Google.Ads.Googleads.V10.Enums.AdGroupTypeEnum.AdGroupType.t(),
          ad_rotation_mode:
            Google.Ads.Googleads.V10.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode.t(),
          ...
          explorer_auto_optimizer_setting:
            Google.Ads.Googleads.V10.Common.ExplorerAutoOptimizerSetting.t() | nil,
          ...
          audience_setting: Google.Ads.Googleads.V10.Resources.AdGroup.AudienceSetting.t() | nil,
