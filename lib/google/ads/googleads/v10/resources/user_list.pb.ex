defmodule Google.Ads.Googleads.V10.Resources.UserList do
  ...
  @type t :: %__MODULE__{
          user_list:
            {:crm_based_user_list, Google.Ads.Googleads.V10.Common.CrmBasedUserListInfo.t() | nil}
            | {:similar_user_list, Google.Ads.Googleads.V10.Common.SimilarUserListInfo.t() | nil}
            | {:rule_based_user_list,
               Google.Ads.Googleads.V10.Common.RuleBasedUserListInfo.t() | nil}
            | {:logical_user_list, Google.Ads.Googleads.V10.Common.LogicalUserListInfo.t() | nil}
            | {:basic_user_list, Google.Ads.Googleads.V10.Common.BasicUserListInfo.t() | nil},
          ...
          membership_status:
            Google.Ads.Googleads.V10.Enums.UserListMembershipStatusEnum.UserListMembershipStatus.t(),
          integration_code: String.t(),
          membership_life_span: integer,
          size_for_display: integer,
          size_range_for_display:
            Google.Ads.Googleads.V10.Enums.UserListSizeRangeEnum.UserListSizeRange.t(),
          size_for_search: integer,
          size_range_for_search:
            Google.Ads.Googleads.V10.Enums.UserListSizeRangeEnum.UserListSizeRange.t(),
          type: Google.Ads.Googleads.V10.Enums.UserListTypeEnum.UserListType.t(),
          closing_reason:
            Google.Ads.Googleads.V10.Enums.UserListClosingReasonEnum.UserListClosingReason.t(),
          access_reason: Google.Ads.Googleads.V10.Enums.AccessReasonEnum.AccessReason.t(),
          account_user_list_status:
            Google.Ads.Googleads.V10.Enums.UserListAccessStatusEnum.UserListAccessStatus.t(),
