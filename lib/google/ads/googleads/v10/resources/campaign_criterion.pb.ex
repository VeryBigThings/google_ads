defmodule Google.Ads.Googleads.V10.Resources.CampaignCriterion do
  ...
  @type t :: %__MODULE__{
          criterion:
            ...
            | {:location, Google.Ads.Googleads.V10.Common.LocationInfo.t() | nil}
            | {:device, Google.Ads.Googleads.V10.Common.DeviceInfo.t() | nil}
            | {:ad_schedule, Google.Ads.Googleads.V10.Common.AdScheduleInfo.t() | nil}
            ...
            | {:listing_scope, Google.Ads.Googleads.V10.Common.ListingScopeInfo.t() | nil}
            | {:language, Google.Ads.Googleads.V10.Common.LanguageInfo.t() | nil}
            | {:ip_block, Google.Ads.Googleads.V10.Common.IpBlockInfo.t() | nil}
            | {:content_label, Google.Ads.Googleads.V10.Common.ContentLabelInfo.t() | nil}
            | {:carrier, Google.Ads.Googleads.V10.Common.CarrierInfo.t() | nil}
            ...
            | {:operating_system_version,
               Google.Ads.Googleads.V10.Common.OperatingSystemVersionInfo.t() | nil}
            | {:mobile_device, Google.Ads.Googleads.V10.Common.MobileDeviceInfo.t() | nil}
            | {:location_group, Google.Ads.Googleads.V10.Common.LocationGroupInfo.t() | nil}
            ...
            | {:keyword_theme, Google.Ads.Googleads.V10.Common.KeywordThemeInfo.t() | nil},
          ...
          status:
            Google.Ads.Googleads.V10.Enums.CampaignCriterionStatusEnum.CampaignCriterionStatus.t()
        }
