defmodule Google.Ads.Googleads.V10.Resources.MediaFile do
  ...
  @type t :: %__MODULE__{
          mediatype:
            {:image, Google.Ads.Googleads.V10.Resources.MediaImage.t() | nil}
            | {:media_bundle, Google.Ads.Googleads.V10.Resources.MediaBundle.t() | nil}
            | {:audio, Google.Ads.Googleads.V10.Resources.MediaAudio.t() | nil}
            | {:video, Google.Ads.Googleads.V10.Resources.MediaVideo.t() | nil},
          resource_name: String.t(),
          id: integer,
          type: Google.Ads.Googleads.V10.Enums.MediaTypeEnum.MediaType.t(),
