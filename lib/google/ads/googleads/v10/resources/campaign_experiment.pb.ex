defmodule Google.Ads.Googleads.V10.Resources.CampaignExperiment do
  ...
  @type t :: %__MODULE__{
          ...
          traffic_split_type:
            Google.Ads.Googleads.V10.Enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType.t(),
          experiment_campaign: String.t(),
          status:
            Google.Ads.Googleads.V10.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus.t(),
