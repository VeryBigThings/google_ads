...
defmodule Google.Ads.Googleads.V10.Resources.AccountBudget do
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V10.Enums.AccountBudgetStatusEnum.AccountBudgetStatus.t(),
          name: String.t(),
          ...
          notes: String.t(),
          pending_proposal:
            Google.Ads.Googleads.V10.Resources.AccountBudget.PendingAccountBudgetProposal.t()
            | nil
        }
