...
defmodule Google.Ads.Googleads.V10.Common.DeviceInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.DeviceEnum.Device.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.PreferredContentInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.PreferredContentTypeEnum.PreferredContentType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ListingGroupInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.ListingGroupTypeEnum.ListingGroupType.t(),
          case_value: Google.Ads.Googleads.V10.Common.ListingDimensionInfo.t() | nil,
...
defmodule Google.Ads.Googleads.V10.Common.ListingScopeInfo do
  ...
  @type t :: %__MODULE__{
          dimensions: [Google.Ads.Googleads.V10.Common.ListingDimensionInfo.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Common.ListingDimensionInfo do
  ...
  @type t :: %__MODULE__{
          dimension:
            {:hotel_id, Google.Ads.Googleads.V10.Common.HotelIdInfo.t() | nil}
            | {:hotel_class, Google.Ads.Googleads.V10.Common.HotelClassInfo.t() | nil}
            | {:hotel_country_region,
               Google.Ads.Googleads.V10.Common.HotelCountryRegionInfo.t() | nil}
            | {:hotel_state, Google.Ads.Googleads.V10.Common.HotelStateInfo.t() | nil}
            | {:hotel_city, Google.Ads.Googleads.V10.Common.HotelCityInfo.t() | nil}
            | {:product_bidding_category,
               Google.Ads.Googleads.V10.Common.ProductBiddingCategoryInfo.t() | nil}
            | {:product_brand, Google.Ads.Googleads.V10.Common.ProductBrandInfo.t() | nil}
            | {:product_channel, Google.Ads.Googleads.V10.Common.ProductChannelInfo.t() | nil}
            | {:product_channel_exclusivity,
               Google.Ads.Googleads.V10.Common.ProductChannelExclusivityInfo.t() | nil}
            | {:product_condition, Google.Ads.Googleads.V10.Common.ProductConditionInfo.t() | nil}
            | {:product_custom_attribute,
               Google.Ads.Googleads.V10.Common.ProductCustomAttributeInfo.t() | nil}
            | {:product_item_id, Google.Ads.Googleads.V10.Common.ProductItemIdInfo.t() | nil}
            | {:product_type, Google.Ads.Googleads.V10.Common.ProductTypeInfo.t() | nil}
            | {:unknown_listing_dimension,
               Google.Ads.Googleads.V10.Common.UnknownListingDimensionInfo.t() | nil}
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductBiddingCategoryInfo do
  ...
  @type t :: %__MODULE__{
          ...
          level:
            Google.Ads.Googleads.V10.Enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductChannelInfo do
  ...
  @type t :: %__MODULE__{
          channel: Google.Ads.Googleads.V10.Enums.ProductChannelEnum.ProductChannel.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductChannelExclusivityInfo do
  ...
  @type t :: %__MODULE__{
          channel_exclusivity:
            Google.Ads.Googleads.V10.Enums.ProductChannelExclusivityEnum.ProductChannelExclusivity.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductConditionInfo do
  ...
  @type t :: %__MODULE__{
          condition: Google.Ads.Googleads.V10.Enums.ProductConditionEnum.ProductCondition.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductCustomAttributeInfo do
  ...
  @type t :: %__MODULE__{
          value: String.t(),
          index:
            Google.Ads.Googleads.V10.Enums.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProductTypeInfo do
  ...
  @type t :: %__MODULE__{
          value: String.t(),
          level: Google.Ads.Googleads.V10.Enums.ProductTypeLevelEnum.ProductTypeLevel.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.HotelDateSelectionTypeInfo do
  ...
  @type t :: %__MODULE__{
          type:
            Google.Ads.Googleads.V10.Enums.HotelDateSelectionTypeEnum.HotelDateSelectionType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.HotelCheckInDayInfo do
  ...
  @type t :: %__MODULE__{
          day_of_week: Google.Ads.Googleads.V10.Enums.DayOfWeekEnum.DayOfWeek.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.InteractionTypeInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.InteractionTypeEnum.InteractionType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.AdScheduleInfo do
  ...
  @type t :: %__MODULE__{
          start_minute: Google.Ads.Googleads.V10.Enums.MinuteOfHourEnum.MinuteOfHour.t(),
          end_minute: Google.Ads.Googleads.V10.Enums.MinuteOfHourEnum.MinuteOfHour.t(),
          start_hour: integer,
          end_hour: integer,
          day_of_week: Google.Ads.Googleads.V10.Enums.DayOfWeekEnum.DayOfWeek.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.AgeRangeInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.AgeRangeTypeEnum.AgeRangeType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.GenderInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.GenderTypeEnum.GenderType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.IncomeRangeInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.IncomeRangeTypeEnum.IncomeRangeType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ParentalStatusInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.ParentalStatusTypeEnum.ParentalStatusType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.ProximityInfo do
  ...
  @type t :: %__MODULE__{
          geo_point: Google.Ads.Googleads.V10.Common.GeoPointInfo.t() | nil,
          radius: float | :infinity | :negative_infinity | :nan,
          radius_units:
            Google.Ads.Googleads.V10.Enums.ProximityRadiusUnitsEnum.ProximityRadiusUnits.t(),
          address: Google.Ads.Googleads.V10.Common.AddressInfo.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Common.ContentLabelInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.ContentLabelTypeEnum.ContentLabelType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.WebpageInfo do
  ...
  @type t :: %__MODULE__{
          ...
          conditions: [Google.Ads.Googleads.V10.Common.WebpageConditionInfo.t()],
          coverage_percentage: float | :infinity | :negative_infinity | :nan,
          sample: Google.Ads.Googleads.V10.Common.WebpageSampleInfo.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Common.WebpageConditionInfo do
  ...
  @type t :: %__MODULE__{
          operand:
            Google.Ads.Googleads.V10.Enums.WebpageConditionOperandEnum.WebpageConditionOperand.t(),
          operator:
            Google.Ads.Googleads.V10.Enums.WebpageConditionOperatorEnum.WebpageConditionOperator.t(),
          argument: String.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.AppPaymentModelInfo do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V10.Enums.AppPaymentModelTypeEnum.AppPaymentModelType.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.LocationGroupInfo do
  ...
  @type t :: %__MODULE__{
          ...
          radius: integer,
          radius_units:
            Google.Ads.Googleads.V10.Enums.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnits.t(),
