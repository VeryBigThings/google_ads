...
defmodule Google.Ads.Googleads.V10.Common.UserIdentifier do
  ...
  @type t :: %__MODULE__{
          identifier:
            ...
            | {:address_info, Google.Ads.Googleads.V10.Common.OfflineUserAddressInfo.t() | nil},
          user_identifier_source:
            Google.Ads.Googleads.V10.Enums.UserIdentifierSourceEnum.UserIdentifierSource.t()
        }
...
defmodule Google.Ads.Googleads.V10.Common.TransactionAttribute do
  ...
  @type t :: %__MODULE__{
          ...
          order_id: String.t(),
          store_attribute: Google.Ads.Googleads.V10.Common.StoreAttribute.t() | nil,
          custom_value: String.t(),
          item_attribute: Google.Ads.Googleads.V10.Common.ItemAttribute.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Common.UserData do
  ...
  @type t :: %__MODULE__{
          ...
          transaction_attribute: Google.Ads.Googleads.V10.Common.TransactionAttribute.t() | nil,
          user_attribute: Google.Ads.Googleads.V10.Common.UserAttribute.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Common.UserAttribute do
  ...
  @type t :: %__MODULE__{
          ...
          shopping_loyalty: Google.Ads.Googleads.V10.Common.ShoppingLoyalty.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Common.StoreSalesMetadata do
  ...
  @type t :: %__MODULE__{
          ...
          third_party_metadata:
            Google.Ads.Googleads.V10.Common.StoreSalesThirdPartyMetadata.t() | nil
        }
