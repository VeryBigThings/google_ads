defmodule Google.Ads.Googleads.V2.Services.UploadClickConversionsRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          customer_id: String.t(),
          conversions: [Google.Ads.Googleads.V2.Services.ClickConversion.t()],
  ...
  field(:conversions, 2, repeated: true, type: Google.Ads.Googleads.V2.Services.ClickConversion)
  field(:partial_failure, 3, type: :bool)
  field(:validate_only, 4, type: :bool)
end

defmodule Google.Ads.Googleads.V2.Services.UploadClickConversionsResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          partial_failure_error: Google.Rpc.Status.t() | nil,
          results: [Google.Ads.Googleads.V2.Services.ClickConversionResult.t()]
        }
  defstruct [:partial_failure_error, :results]

  field(:partial_failure_error, 1, type: Google.Rpc.Status)
  field(:results, 2, repeated: true, type: Google.Ads.Googleads.V2.Services.ClickConversionResult)
end

defmodule Google.Ads.Googleads.V2.Services.UploadCallConversionsRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          customer_id: String.t(),
          conversions: [Google.Ads.Googleads.V2.Services.CallConversion.t()],
          partial_failure: boolean,
          validate_only: boolean
        }
  defstruct [:customer_id, :conversions, :partial_failure, :validate_only]
  ...
  field(:customer_id, 1, type: :string)
  field(:conversions, 2, repeated: true, type: Google.Ads.Googleads.V2.Services.CallConversion)
  field(:partial_failure, 3, type: :bool)
  field(:validate_only, 4, type: :bool)
end

defmodule Google.Ads.Googleads.V2.Services.UploadCallConversionsResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          partial_failure_error: Google.Rpc.Status.t() | nil,
          results: [Google.Ads.Googleads.V2.Services.CallConversionResult.t()]
        }
  defstruct [:partial_failure_error, :results]

  field(:partial_failure_error, 1, type: Google.Rpc.Status)
  field(:results, 2, repeated: true, type: Google.Ads.Googleads.V2.Services.CallConversionResult)
end

defmodule Google.Ads.Googleads.V2.Services.ClickConversion do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          external_attribution_data:
            Google.Ads.Googleads.V2.Services.ExternalAttributionData.t() | nil
        }
  defstruct [
    :gclid,
    :conversion_action,
  ...
  field(:external_attribution_data, 7,
    type: Google.Ads.Googleads.V2.Services.ExternalAttributionData
  )
end

defmodule Google.Ads.Googleads.V2.Services.CallConversion do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Services.ExternalAttributionData do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Services.ClickConversionResult do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Services.CallConversionResult do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Services.ConversionUploadService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v2.services.ConversionUploadService"
...
defmodule Google.Ads.Googleads.V2.Services.ConversionUploadService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V2.Services.ConversionUploadService.Service
end
