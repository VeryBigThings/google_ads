defmodule Google.Ads.Googleads.V2.Common.Segments do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          ad_network_type: atom | integer,
          click_type: atom | integer,
          conversion_action: Google.Protobuf.StringValue.t() | nil,
          conversion_action_category: atom | integer,
          conversion_action_name: Google.Protobuf.StringValue.t() | nil,
          conversion_adjustment: Google.Protobuf.BoolValue.t() | nil,
          conversion_attribution_event_type: atom | integer,
          conversion_lag_bucket: atom | integer,
          conversion_or_adjustment_lag_bucket: atom | integer,
          date: Google.Protobuf.StringValue.t() | nil,
          day_of_week: atom | integer,
          device: atom | integer,
          external_conversion_source: atom | integer,
          ...
          hotel_check_in_day_of_week: atom | integer,
          ...
          keyword: Google.Ads.Googleads.V2.Common.Keyword.t() | nil,
          month: Google.Protobuf.StringValue.t() | nil,
          month_of_year: atom | integer,
          partner_hotel_id: Google.Protobuf.StringValue.t() | nil,
          placeholder_type: atom | integer,
          ...
          product_channel: atom | integer,
          product_channel_exclusivity: atom | integer,
          product_condition: atom | integer,
          ...
          search_engine_results_page_type: atom | integer,
          search_term_match_type: atom | integer,
          slot: atom | integer,
  ...
  field(:ad_network_type, 3,
    type: Google.Ads.Googleads.V2.Enums.AdNetworkTypeEnum.AdNetworkType,
    enum: true
  )

  field(:click_type, 26, type: Google.Ads.Googleads.V2.Enums.ClickTypeEnum.ClickType, enum: true)
  ...
  field(:conversion_lag_bucket, 50,
    type: Google.Ads.Googleads.V2.Enums.ConversionLagBucketEnum.ConversionLagBucket,
    enum: true
  )
  ...
  field(:device, 1, type: Google.Ads.Googleads.V2.Enums.DeviceEnum.Device, enum: true)

  field(:external_conversion_source, 55,
    type: Google.Ads.Googleads.V2.Enums.ExternalConversionSourceEnum.ExternalConversionSource,
    enum: true
  )
  ...
  field(:hotel_check_in_day_of_week, 9,
    type: Google.Ads.Googleads.V2.Enums.DayOfWeekEnum.DayOfWeek,
    enum: true
  )
  ...
  field(:hotel_rate_type, 74,
    type: Google.Ads.Googleads.V2.Enums.HotelRateTypeEnum.HotelRateType,
    enum: true
  )
  ...
  field(:keyword, 61, type: Google.Ads.Googleads.V2.Common.Keyword)
  field(:month, 17, type: Google.Protobuf.StringValue)

  field(:month_of_year, 18,
    type: Google.Ads.Googleads.V2.Enums.MonthOfYearEnum.MonthOfYear,
    enum: true
  )
  ...
  field(:search_term_match_type, 22,
    type: Google.Ads.Googleads.V2.Enums.SearchTermMatchTypeEnum.SearchTermMatchType,
    enum: true
  )

  field(:slot, 23, type: Google.Ads.Googleads.V2.Enums.SlotEnum.Slot, enum: true)
...
defmodule Google.Ads.Googleads.V2.Common.Keyword do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          ad_group_criterion: Google.Protobuf.StringValue.t() | nil,
          info: Google.Ads.Googleads.V2.Common.KeywordInfo.t() | nil
        }
  defstruct [:ad_group_criterion, :info]

  field(:ad_group_criterion, 1, type: Google.Protobuf.StringValue)
  field(:info, 2, type: Google.Ads.Googleads.V2.Common.KeywordInfo)
end
