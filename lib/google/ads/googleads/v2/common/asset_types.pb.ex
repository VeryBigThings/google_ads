defmodule Google.Ads.Googleads.V2.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Common.MediaBundleAsset do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ImageAsset do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          full_size: Google.Ads.Googleads.V2.Common.ImageDimension.t() | nil
        }
  defstruct [:data, :file_size, :mime_type, :full_size]

  field(:data, 1, type: Google.Protobuf.BytesValue)
  field(:file_size, 2, type: Google.Protobuf.Int64Value)
  field(:mime_type, 3, type: Google.Ads.Googleads.V2.Enums.MimeTypeEnum.MimeType, enum: true)
  field(:full_size, 4, type: Google.Ads.Googleads.V2.Common.ImageDimension)
end

defmodule Google.Ads.Googleads.V2.Common.ImageDimension do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.TextAsset do
  @moduledoc false
  use Protobuf, syntax: :proto3
