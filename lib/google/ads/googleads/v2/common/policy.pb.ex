defmodule Google.Ads.Googleads.V2.Common.PolicyViolationKey do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Common.PolicyValidationParameter do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          ignorable_policy_topics: [Google.Protobuf.StringValue.t()],
          exempt_policy_violation_keys: [Google.Ads.Googleads.V2.Common.PolicyViolationKey.t()]
        }
  ...
  field(:exempt_policy_violation_keys, 2,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.PolicyViolationKey
  )
end

defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEntry do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          type: atom | integer,
          evidences: [Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.t()],
          constraints: [Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.t()]
        }
  ...
  field(:type, 2,
    type: Google.Ads.Googleads.V2.Enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType,
    enum: true
  )

  field(:evidences, 3, repeated: true, type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence)

  field(:constraints, 4,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicConstraint
  )
end

defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:website_list, 3,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.WebsiteList,
    oneof: 0
  )

  field(:text_list, 4, type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.TextList, oneof: 0)

  field(:language_code, 5, type: Google.Protobuf.StringValue, oneof: 0)

  field(:destination_text_list, 6,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationTextList,
    oneof: 0
  )

  field(:destination_mismatch, 7,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationMismatch,
    oneof: 0
  )

  field(:destination_not_working, 8,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationNotWorking,
    oneof: 0
  )
end

defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.TextList do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.WebsiteList do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationTextList do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationMismatch do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          url_types: [atom | integer]
        }
  defstruct [:url_types]
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicEvidence.DestinationNotWorking do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicConstraint do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:country_constraint_list, 1,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.CountryConstraintList,
    oneof: 0
  )

  field(:reseller_constraint, 2,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.ResellerConstraint,
    oneof: 0
  )
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.CountryConstraintList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          total_targeted_countries: Google.Protobuf.Int32Value.t() | nil,
          countries: [Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.CountryConstraint.t()]
        }
  ...
  field(:countries, 2,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.CountryConstraint
  )
end

defmodule Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.ResellerConstraint do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PolicyTopicConstraint.CountryConstraint do
  @moduledoc false
  use Protobuf, syntax: :proto3
