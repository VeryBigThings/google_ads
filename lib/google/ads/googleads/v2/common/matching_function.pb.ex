defmodule Google.Ads.Googleads.V2.Common.MatchingFunction do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          left_operands: [Google.Ads.Googleads.V2.Common.Operand.t()],
          right_operands: [Google.Ads.Googleads.V2.Common.Operand.t()]
        }
  ...
  field(:operator, 4,
    type: Google.Ads.Googleads.V2.Enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator,
    enum: true
  )

  field(:left_operands, 2, repeated: true, type: Google.Ads.Googleads.V2.Common.Operand)
  field(:right_operands, 3, repeated: true, type: Google.Ads.Googleads.V2.Common.Operand)
end

defmodule Google.Ads.Googleads.V2.Common.Operand do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:constant_operand, 1,
    type: Google.Ads.Googleads.V2.Common.Operand.ConstantOperand,
    oneof: 0
  )

  field(:feed_attribute_operand, 2,
    type: Google.Ads.Googleads.V2.Common.Operand.FeedAttributeOperand,
    oneof: 0
  )

  field(:function_operand, 3,
    type: Google.Ads.Googleads.V2.Common.Operand.FunctionOperand,
    oneof: 0
  )

  field(:request_context_operand, 4,
    type: Google.Ads.Googleads.V2.Common.Operand.RequestContextOperand,
    oneof: 0
  )
end

defmodule Google.Ads.Googleads.V2.Common.Operand.ConstantOperand do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.Operand.FeedAttributeOperand do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.Operand.FunctionOperand do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:matching_function, 1, type: Google.Ads.Googleads.V2.Common.MatchingFunction)
end

defmodule Google.Ads.Googleads.V2.Common.Operand.RequestContextOperand do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          context_type: atom | integer
        }
