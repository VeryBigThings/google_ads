defmodule Google.Ads.Googleads.V2.Common.TextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Common.ExpandedTextAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.CallOnlyAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          conversion_reporting_state: atom | integer
        }
  defstruct [
    :country_code,
    :phone_number,
...
defmodule Google.Ads.Googleads.V2.Common.ExpandedDynamicSearchAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.HotelAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ShoppingSmartAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ShoppingProductAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ShoppingComparisonListingAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.GmailAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          teaser: Google.Ads.Googleads.V2.Common.GmailTeaser.t() | nil,
          ...
          marketing_image_display_call_to_action:
            Google.Ads.Googleads.V2.Common.DisplayCallToAction.t() | nil,
          product_images: [Google.Ads.Googleads.V2.Common.ProductImage.t()],
          product_videos: [Google.Ads.Googleads.V2.Common.ProductVideo.t()]
        }
  defstruct [
    :teaser,
    :header_image,
  ...
  field(:teaser, 1, type: Google.Ads.Googleads.V2.Common.GmailTeaser)
  ...
  field(:marketing_image_display_call_to_action, 6,
    type: Google.Ads.Googleads.V2.Common.DisplayCallToAction
  )

  field(:product_images, 7, repeated: true, type: Google.Ads.Googleads.V2.Common.ProductImage)
  field(:product_videos, 8, repeated: true, type: Google.Ads.Googleads.V2.Common.ProductVideo)
end

defmodule Google.Ads.Googleads.V2.Common.GmailTeaser do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.DisplayCallToAction do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ProductImage do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          description: Google.Protobuf.StringValue.t() | nil,
          display_call_to_action: Google.Ads.Googleads.V2.Common.DisplayCallToAction.t() | nil
        }
  defstruct [:product_image, :description, :display_call_to_action]

  field(:product_image, 1, type: Google.Protobuf.StringValue)
  field(:description, 2, type: Google.Protobuf.StringValue)
  field(:display_call_to_action, 3, type: Google.Ads.Googleads.V2.Common.DisplayCallToAction)
end

defmodule Google.Ads.Googleads.V2.Common.ProductVideo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.ImageAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:mime_type, 10, type: Google.Ads.Googleads.V2.Enums.MimeTypeEnum.MimeType, enum: true)
...
defmodule Google.Ads.Googleads.V2.Common.VideoBumperInStreamAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.VideoNonSkippableInStreamAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.VideoTrueViewInStreamAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.VideoOutstreamAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.VideoAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:in_stream, 2, type: Google.Ads.Googleads.V2.Common.VideoTrueViewInStreamAdInfo, oneof: 0)
  field(:bumper, 3, type: Google.Ads.Googleads.V2.Common.VideoBumperInStreamAdInfo, oneof: 0)
  field(:out_stream, 4, type: Google.Ads.Googleads.V2.Common.VideoOutstreamAdInfo, oneof: 0)

  field(:non_skippable, 5,
    type: Google.Ads.Googleads.V2.Common.VideoNonSkippableInStreamAdInfo,
    oneof: 0
  )
end

defmodule Google.Ads.Googleads.V2.Common.ResponsiveSearchAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          headlines: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          descriptions: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          path1: Google.Protobuf.StringValue.t() | nil,
          path2: Google.Protobuf.StringValue.t() | nil
        }
  defstruct [:headlines, :descriptions, :path1, :path2]

  field(:headlines, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:descriptions, 2, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:path1, 3, type: Google.Protobuf.StringValue)
  field(:path2, 4, type: Google.Protobuf.StringValue)
end

defmodule Google.Ads.Googleads.V2.Common.LegacyResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:format_setting, 13,
    type: Google.Ads.Googleads.V2.Enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting,
    enum: true
  )
...
defmodule Google.Ads.Googleads.V2.Common.AppAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          mandatory_ad_text: Google.Ads.Googleads.V2.Common.AdTextAsset.t() | nil,
          headlines: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          descriptions: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          youtube_videos: [Google.Ads.Googleads.V2.Common.AdVideoAsset.t()],
          html5_media_bundles: [Google.Ads.Googleads.V2.Common.AdMediaBundleAsset.t()]
        }
  defstruct [
    :mandatory_ad_text,
    :headlines,
  ...
  field(:mandatory_ad_text, 1, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:headlines, 2, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:descriptions, 3, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:images, 4, repeated: true, type: Google.Ads.Googleads.V2.Common.AdImageAsset)
  field(:youtube_videos, 5, repeated: true, type: Google.Ads.Googleads.V2.Common.AdVideoAsset)

  field(:html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.AdMediaBundleAsset
  )
end

defmodule Google.Ads.Googleads.V2.Common.AppEngagementAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          descriptions: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          videos: [Google.Ads.Googleads.V2.Common.AdVideoAsset.t()]
        }
  defstruct [:headlines, :descriptions, :images, :videos]

  field(:headlines, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:descriptions, 2, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:images, 3, repeated: true, type: Google.Ads.Googleads.V2.Common.AdImageAsset)
  field(:videos, 4, repeated: true, type: Google.Ads.Googleads.V2.Common.AdVideoAsset)
end

defmodule Google.Ads.Googleads.V2.Common.LegacyAppInstallAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          app_id: Google.Protobuf.StringValue.t() | nil,
          app_store: atom | integer,
          headline: Google.Protobuf.StringValue.t() | nil,
          description1: Google.Protobuf.StringValue.t() | nil,
          description2: Google.Protobuf.StringValue.t() | nil
        }
  ...
  field(:app_store, 2,
    type: Google.Ads.Googleads.V2.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    enum: true
  )
...
defmodule Google.Ads.Googleads.V2.Common.ResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          marketing_images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          square_marketing_images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          logo_images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          square_logo_images: [Google.Ads.Googleads.V2.Common.AdImageAsset.t()],
          headlines: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          long_headline: Google.Ads.Googleads.V2.Common.AdTextAsset.t() | nil,
          descriptions: [Google.Ads.Googleads.V2.Common.AdTextAsset.t()],
          youtube_videos: [Google.Ads.Googleads.V2.Common.AdVideoAsset.t()],
          business_name: Google.Protobuf.StringValue.t() | nil,
          main_color: Google.Protobuf.StringValue.t() | nil,
  ...
  field(:marketing_images, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.AdImageAsset)

  field(:square_marketing_images, 2,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.AdImageAsset
  )

  field(:logo_images, 3, repeated: true, type: Google.Ads.Googleads.V2.Common.AdImageAsset)
  field(:square_logo_images, 4, repeated: true, type: Google.Ads.Googleads.V2.Common.AdImageAsset)
  field(:headlines, 5, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:long_headline, 6, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:descriptions, 7, repeated: true, type: Google.Ads.Googleads.V2.Common.AdTextAsset)
  field(:youtube_videos, 8, repeated: true, type: Google.Ads.Googleads.V2.Common.AdVideoAsset)
...
defmodule Google.Ads.Googleads.V2.Common.DisplayUploadAdInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          media_asset: {atom, any},
          display_upload_product_type: atom | integer
        }
  ...
  field(:display_upload_product_type, 1,
    type: Google.Ads.Googleads.V2.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType,
    enum: true
  )

  field(:media_bundle, 2, type: Google.Ads.Googleads.V2.Common.AdMediaBundleAsset, oneof: 0)
end
