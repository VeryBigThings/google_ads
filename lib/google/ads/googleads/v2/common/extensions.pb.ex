defmodule Google.Ads.Googleads.V2.Common.AppFeedItem do
  @moduledoc false
  ...
  field(:app_store, 3, type: Google.Ads.Googleads.V2.Enums.AppStoreEnum.AppStore, enum: true)
...
defmodule Google.Ads.Googleads.V2.Common.CallFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          call_conversion_reporting_state: atom | integer
        }
  defstruct [
    :phone_number,
    :country_code,
...
defmodule Google.Ads.Googleads.V2.Common.CalloutFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.LocationFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.AffiliateLocationFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.TextMessageFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.PriceFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          type: atom | integer,
          price_qualifier: atom | integer,
          tracking_url_template: Google.Protobuf.StringValue.t() | nil,
          language_code: Google.Protobuf.StringValue.t() | nil,
          price_offerings: [Google.Ads.Googleads.V2.Common.PriceOffer.t()],
          final_url_suffix: Google.Protobuf.StringValue.t() | nil
        }
  defstruct [
    :type,
  ...
  field(:type, 1,
    type: Google.Ads.Googleads.V2.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true
  )
  ...
  field(:price_offerings, 5, repeated: true, type: Google.Ads.Googleads.V2.Common.PriceOffer)
  field(:final_url_suffix, 6, type: Google.Protobuf.StringValue)
end

defmodule Google.Ads.Googleads.V2.Common.PriceOffer do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          price: Google.Ads.Googleads.V2.Common.Money.t() | nil,
          unit: atom | integer,
          final_urls: [Google.Protobuf.StringValue.t()],
          final_mobile_urls: [Google.Protobuf.StringValue.t()]
        }
  ...
  field(:price, 3, type: Google.Ads.Googleads.V2.Common.Money)

  field(:unit, 4,
    type: Google.Ads.Googleads.V2.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
  )
...
defmodule Google.Ads.Googleads.V2.Common.PromotionFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:occasion, 9,
    type: Google.Ads.Googleads.V2.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
  )
  ...
  field(:money_amount_off, 4, type: Google.Ads.Googleads.V2.Common.Money, oneof: 0)
  field(:promotion_code, 5, type: Google.Protobuf.StringValue, oneof: 1)
  field(:orders_over_amount, 6, type: Google.Ads.Googleads.V2.Common.Money, oneof: 1)
end

defmodule Google.Ads.Googleads.V2.Common.StructuredSnippetFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.SitelinkFeedItem do
  @moduledoc false
  use Protobuf, syntax: :proto3
