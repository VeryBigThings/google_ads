defmodule Google.Ads.Googleads.V2.Common.Metrics do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          historical_creative_quality_score: atom | integer,
          historical_landing_page_quality_score: atom | integer,
          historical_quality_score: Google.Protobuf.Int64Value.t() | nil,
          historical_search_predicted_ctr: atom | integer,
          ...
          interaction_event_types: [atom | integer],
  ...
  field(:interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V2.Enums.InteractionEventTypeEnum.InteractionEventType,
    enum: true
  )
