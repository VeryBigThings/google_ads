defmodule Google.Ads.Googleads.V2.Common.BidModifierSimulationPointList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          points: [Google.Ads.Googleads.V2.Common.BidModifierSimulationPoint.t()]
        }
  defstruct [:points]

  field(:points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.BidModifierSimulationPoint
  )
end

defmodule Google.Ads.Googleads.V2.Common.CpcBidSimulationPointList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          points: [Google.Ads.Googleads.V2.Common.CpcBidSimulationPoint.t()]
        }
  defstruct [:points]

  field(:points, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.CpcBidSimulationPoint)
end

defmodule Google.Ads.Googleads.V2.Common.CpvBidSimulationPointList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          points: [Google.Ads.Googleads.V2.Common.CpvBidSimulationPoint.t()]
        }
  defstruct [:points]

  field(:points, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.CpvBidSimulationPoint)
end

defmodule Google.Ads.Googleads.V2.Common.TargetCpaSimulationPointList do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          points: [Google.Ads.Googleads.V2.Common.TargetCpaSimulationPoint.t()]
        }
  defstruct [:points]

  field(:points, 1, repeated: true, type: Google.Ads.Googleads.V2.Common.TargetCpaSimulationPoint)
end

defmodule Google.Ads.Googleads.V2.Common.BidModifierSimulationPoint do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.CpcBidSimulationPoint do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.CpvBidSimulationPoint do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Common.TargetCpaSimulationPoint do
  @moduledoc false
  use Protobuf, syntax: :proto3
