defmodule Google.Ads.Googleads.V2.Resources.CampaignSharedSet do
  @moduledoc false
  ...
  field(:status, 2,
    type: Google.Ads.Googleads.V2.Enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus,
    enum: true
  )
end
