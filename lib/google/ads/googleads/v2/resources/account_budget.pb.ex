defmodule Google.Ads.Googleads.V2.Resources.AccountBudget do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          pending_proposal:
            Google.Ads.Googleads.V2.Resources.AccountBudget.PendingAccountBudgetProposal.t() | nil
        }
  defstruct [
    :proposed_end_time,
    :approved_end_time,
  ...
  field(:status, 4,
    type: Google.Ads.Googleads.V2.Enums.AccountBudgetStatusEnum.AccountBudgetStatus,
    enum: true
  )
  ...
  field(:pending_proposal, 22,
    type: Google.Ads.Googleads.V2.Resources.AccountBudget.PendingAccountBudgetProposal
  )

  field(:proposed_end_date_time, 8, type: Google.Protobuf.StringValue, oneof: 0)

  field(:proposed_end_time_type, 9,
    type: Google.Ads.Googleads.V2.Enums.TimeTypeEnum.TimeType,
    enum: true,
    oneof: 0
  )
  ...
  field(:proposed_spending_limit_type, 13,
    type: Google.Ads.Googleads.V2.Enums.SpendingLimitTypeEnum.SpendingLimitType,
    enum: true,
    oneof: 2
  )
...
defmodule Google.Ads.Googleads.V2.Resources.AccountBudget.PendingAccountBudgetProposal do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:proposal_type, 2,
    type: Google.Ads.Googleads.V2.Enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType,
    enum: true
  )
