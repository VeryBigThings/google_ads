defmodule Google.Ads.Googleads.V2.Resources.CampaignBidModifier do
  @moduledoc false
  ...
  field(:interaction_type, 5, type: Google.Ads.Googleads.V2.Common.InteractionTypeInfo, oneof: 0)
end
