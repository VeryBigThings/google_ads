defmodule Google.Ads.Googleads.V2.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field(:status, 7,
    type: Google.Ads.Googleads.V2.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true
  )
