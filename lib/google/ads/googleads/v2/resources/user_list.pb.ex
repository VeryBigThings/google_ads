defmodule Google.Ads.Googleads.V2.Resources.UserList do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          membership_status: atom | integer,
          ...
          size_range_for_display: atom | integer,
          size_for_search: Google.Protobuf.Int64Value.t() | nil,
          size_range_for_search: atom | integer,
          type: atom | integer,
          closing_reason: atom | integer,
          access_reason: atom | integer,
          account_user_list_status: atom | integer,
  ...
  field(:membership_status, 6,
    type: Google.Ads.Googleads.V2.Enums.UserListMembershipStatusEnum.UserListMembershipStatus,
    enum: true
  )
  ...
  field(:size_range_for_display, 10,
    type: Google.Ads.Googleads.V2.Enums.UserListSizeRangeEnum.UserListSizeRange,
    enum: true
  )
  ...
  field(:type, 13, type: Google.Ads.Googleads.V2.Enums.UserListTypeEnum.UserListType, enum: true)

  field(:closing_reason, 14,
    type: Google.Ads.Googleads.V2.Enums.UserListClosingReasonEnum.UserListClosingReason,
    enum: true
  )

  field(:access_reason, 15,
    type: Google.Ads.Googleads.V2.Enums.AccessReasonEnum.AccessReason,
    enum: true
  )

  field(:account_user_list_status, 16,
    type: Google.Ads.Googleads.V2.Enums.UserListAccessStatusEnum.UserListAccessStatus,
    enum: true
  )
  ...
  field(:crm_based_user_list, 19,
    type: Google.Ads.Googleads.V2.Common.CrmBasedUserListInfo,
    oneof: 0
  )

  field(:similar_user_list, 20, type: Google.Ads.Googleads.V2.Common.SimilarUserListInfo, oneof: 0)

  field(:rule_based_user_list, 21,
    type: Google.Ads.Googleads.V2.Common.RuleBasedUserListInfo,
    oneof: 0
  )

  field(:logical_user_list, 22, type: Google.Ads.Googleads.V2.Common.LogicalUserListInfo, oneof: 0)

  field(:basic_user_list, 23, type: Google.Ads.Googleads.V2.Common.BasicUserListInfo, oneof: 0)
end
