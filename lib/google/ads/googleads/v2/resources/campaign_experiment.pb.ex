defmodule Google.Ads.Googleads.V2.Resources.CampaignExperiment do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          traffic_split_type: atom | integer,
  ...
  field(:status, 9,
    type: Google.Ads.Googleads.V2.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus,
    enum: true
  )
