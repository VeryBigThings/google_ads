defmodule Google.Ads.Googleads.V2.Resources.SharedCriterion do
  @moduledoc false
  ...
  field(:type, 4, type: Google.Ads.Googleads.V2.Enums.CriterionTypeEnum.CriterionType, enum: true)
  field(:keyword, 3, type: Google.Ads.Googleads.V2.Common.KeywordInfo, oneof: 0)
  field(:youtube_video, 5, type: Google.Ads.Googleads.V2.Common.YouTubeVideoInfo, oneof: 0)
  field(:youtube_channel, 6, type: Google.Ads.Googleads.V2.Common.YouTubeChannelInfo, oneof: 0)
