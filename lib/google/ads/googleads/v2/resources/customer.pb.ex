defmodule Google.Ads.Googleads.V2.Resources.Customer do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          call_reporting_setting:
            Google.Ads.Googleads.V2.Resources.CallReportingSetting.t() | nil,
          conversion_tracking_setting:
            Google.Ads.Googleads.V2.Resources.ConversionTrackingSetting.t() | nil,
          remarketing_setting: Google.Ads.Googleads.V2.Resources.RemarketingSetting.t() | nil,
          pay_per_conversion_eligibility_failure_reasons: [atom | integer]
        }
  defstruct [
    :resource_name,
    :id,
  ...
  field(:call_reporting_setting, 10, type: Google.Ads.Googleads.V2.Resources.CallReportingSetting)

  field(:conversion_tracking_setting, 14,
    type: Google.Ads.Googleads.V2.Resources.ConversionTrackingSetting
  )

  field(:remarketing_setting, 15, type: Google.Ads.Googleads.V2.Resources.RemarketingSetting)
...
defmodule Google.Ads.Googleads.V2.Resources.CallReportingSetting do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.ConversionTrackingSetting do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.RemarketingSetting do
  @moduledoc false
  use Protobuf, syntax: :proto3
