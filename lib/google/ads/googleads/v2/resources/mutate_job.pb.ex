defmodule Google.Ads.Googleads.V2.Resources.MutateJob do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          metadata: Google.Ads.Googleads.V2.Resources.MutateJob.MutateJobMetadata.t() | nil,
          status: atom | integer,
  ...
  field(:metadata, 4, type: Google.Ads.Googleads.V2.Resources.MutateJob.MutateJobMetadata)

  field(:status, 5,
    type: Google.Ads.Googleads.V2.Enums.MutateJobStatusEnum.MutateJobStatus,
    enum: true
  )
...
defmodule Google.Ads.Googleads.V2.Resources.MutateJob.MutateJobMetadata do
  @moduledoc false
  use Protobuf, syntax: :proto3
