defmodule Google.Ads.Googleads.V2.Resources.DetailPlacementView do
  @moduledoc false
  ...
  field(:placement_type, 6,
    type: Google.Ads.Googleads.V2.Enums.PlacementTypeEnum.PlacementType,
    enum: true
  )
end
