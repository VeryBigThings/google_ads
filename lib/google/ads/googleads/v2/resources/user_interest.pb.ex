defmodule Google.Ads.Googleads.V2.Resources.UserInterest do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          resource_name: String.t(),
          taxonomy_type: atom | integer,
          ...
          availabilities: [Google.Ads.Googleads.V2.Common.CriterionCategoryAvailability.t()]
        }
  defstruct [
    :resource_name,
    :taxonomy_type,
  ...
  field(:taxonomy_type, 2,
    type: Google.Ads.Googleads.V2.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
    enum: true
  )
  ...
  field(:availabilities, 7,
    repeated: true,
    type: Google.Ads.Googleads.V2.Common.CriterionCategoryAvailability
  )
end
