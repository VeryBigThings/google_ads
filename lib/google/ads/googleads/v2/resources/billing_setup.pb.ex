defmodule Google.Ads.Googleads.V2.Resources.BillingSetup do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          payments_account_info:
            Google.Ads.Googleads.V2.Resources.BillingSetup.PaymentsAccountInfo.t() | nil
        }
  defstruct [
    :start_time,
    :end_time,
  ...
  field(:status, 3,
    type: Google.Ads.Googleads.V2.Enums.BillingSetupStatusEnum.BillingSetupStatus,
    enum: true
  )
  ...
  field(:payments_account_info, 12,
    type: Google.Ads.Googleads.V2.Resources.BillingSetup.PaymentsAccountInfo
  )
...
defmodule Google.Ads.Googleads.V2.Resources.BillingSetup.PaymentsAccountInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
