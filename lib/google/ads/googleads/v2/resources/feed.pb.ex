defmodule Google.Ads.Googleads.V2.Resources.Feed do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          attributes: [Google.Ads.Googleads.V2.Resources.FeedAttribute.t()],
          attribute_operations: [Google.Ads.Googleads.V2.Resources.FeedAttributeOperation.t()],
          origin: atom | integer,
          status: atom | integer
        }
  defstruct [
  ...
  field(:attributes, 4, repeated: true, type: Google.Ads.Googleads.V2.Resources.FeedAttribute)

  field(:attribute_operations, 9,
    repeated: true,
    type: Google.Ads.Googleads.V2.Resources.FeedAttributeOperation
  )

  field(:origin, 5, type: Google.Ads.Googleads.V2.Enums.FeedOriginEnum.FeedOrigin, enum: true)
  field(:status, 8, type: Google.Ads.Googleads.V2.Enums.FeedStatusEnum.FeedStatus, enum: true)

  field(:places_location_feed_data, 6,
    type: Google.Ads.Googleads.V2.Resources.Feed.PlacesLocationFeedData,
    oneof: 0
  )

  field(:affiliate_location_feed_data, 7,
    type: Google.Ads.Googleads.V2.Resources.Feed.AffiliateLocationFeedData,
    oneof: 0
  )
end

defmodule Google.Ads.Googleads.V2.Resources.Feed.PlacesLocationFeedData do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          oauth_info:
            Google.Ads.Googleads.V2.Resources.Feed.PlacesLocationFeedData.OAuthInfo.t() | nil,
  ...
  field(:oauth_info, 1,
    type: Google.Ads.Googleads.V2.Resources.Feed.PlacesLocationFeedData.OAuthInfo
  )
...
defmodule Google.Ads.Googleads.V2.Resources.Feed.PlacesLocationFeedData.OAuthInfo do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.Feed.AffiliateLocationFeedData do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          chain_ids: [Google.Protobuf.Int64Value.t()],
          relationship_type: atom | integer
        }
...
defmodule Google.Ads.Googleads.V2.Resources.FeedAttribute do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field(:type, 3,
    type: Google.Ads.Googleads.V2.Enums.FeedAttributeTypeEnum.FeedAttributeType,
    enum: true
  )
...
defmodule Google.Ads.Googleads.V2.Resources.FeedAttributeOperation do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          operator: atom | integer,
          value: Google.Ads.Googleads.V2.Resources.FeedAttribute.t() | nil
        }
  defstruct [:operator, :value]

  field(:operator, 1,
    type: Google.Ads.Googleads.V2.Resources.FeedAttributeOperation.Operator,
    enum: true
  )

  field(:value, 2, type: Google.Ads.Googleads.V2.Resources.FeedAttribute)
end

defmodule Google.Ads.Googleads.V2.Resources.FeedAttributeOperation.Operator do
  @moduledoc false
