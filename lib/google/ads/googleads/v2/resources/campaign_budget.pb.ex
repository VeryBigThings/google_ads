defmodule Google.Ads.Googleads.V2.Resources.CampaignBudget do
  @moduledoc false
  ...
  field(:status, 6, type: Google.Ads.Googleads.V2.Enums.BudgetStatusEnum.BudgetStatus, enum: true)

  field(:delivery_method, 7,
    type: Google.Ads.Googleads.V2.Enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod,
    enum: true
  )
  ...
  field(:period, 13, type: Google.Ads.Googleads.V2.Enums.BudgetPeriodEnum.BudgetPeriod, enum: true)
  ...
  field(:type, 18, type: Google.Ads.Googleads.V2.Enums.BudgetTypeEnum.BudgetType, enum: true)
end
