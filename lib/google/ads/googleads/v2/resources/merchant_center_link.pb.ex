defmodule Google.Ads.Googleads.V2.Resources.MerchantCenterLink do
  @moduledoc false
  ...
  field(:status, 5,
    type: Google.Ads.Googleads.V2.Enums.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus,
    enum: true
  )
end
