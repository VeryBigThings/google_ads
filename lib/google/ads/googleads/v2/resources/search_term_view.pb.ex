defmodule Google.Ads.Googleads.V2.Resources.SearchTermView do
  @moduledoc false
  ...
  field(:status, 4,
    type: Google.Ads.Googleads.V2.Enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus,
    enum: true
  )
end
