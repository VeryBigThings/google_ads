defmodule Google.Ads.Googleads.V2.Resources.SharedSet do
  @moduledoc false
  ...
  field(:type, 3, type: Google.Ads.Googleads.V2.Enums.SharedSetTypeEnum.SharedSetType, enum: true)
  field(:name, 4, type: Google.Protobuf.StringValue)

  field(:status, 5,
    type: Google.Ads.Googleads.V2.Enums.SharedSetStatusEnum.SharedSetStatus,
    enum: true
  )
