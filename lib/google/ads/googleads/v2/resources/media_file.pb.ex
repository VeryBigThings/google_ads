defmodule Google.Ads.Googleads.V2.Resources.MediaFile do
  @moduledoc false
  ...
  field(:type, 5, type: Google.Ads.Googleads.V2.Enums.MediaTypeEnum.MediaType, enum: true)
  field(:mime_type, 6, type: Google.Ads.Googleads.V2.Enums.MimeTypeEnum.MimeType, enum: true)
  ...
  field(:image, 3, type: Google.Ads.Googleads.V2.Resources.MediaImage, oneof: 0)
  field(:media_bundle, 4, type: Google.Ads.Googleads.V2.Resources.MediaBundle, oneof: 0)
  field(:audio, 10, type: Google.Ads.Googleads.V2.Resources.MediaAudio, oneof: 0)
  field(:video, 11, type: Google.Ads.Googleads.V2.Resources.MediaVideo, oneof: 0)
end

defmodule Google.Ads.Googleads.V2.Resources.MediaImage do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.MediaBundle do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.MediaAudio do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V2.Resources.MediaVideo do
  @moduledoc false
  use Protobuf, syntax: :proto3
