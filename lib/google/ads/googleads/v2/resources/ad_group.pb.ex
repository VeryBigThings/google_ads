defmodule Google.Ads.Googleads.V2.Resources.AdGroup do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          explorer_auto_optimizer_setting:
            Google.Ads.Googleads.V2.Common.ExplorerAutoOptimizerSetting.t() | nil,
          display_custom_bid_dimension: atom | integer,
          ...
          effective_target_cpa_source: atom | integer,
          effective_target_roas: Google.Protobuf.DoubleValue.t() | nil,
          effective_target_roas_source: atom | integer,
  ...
  field(:status, 5,
    type: Google.Ads.Googleads.V2.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true
  )

  field(:type, 12, type: Google.Ads.Googleads.V2.Enums.AdGroupTypeEnum.AdGroupType, enum: true)

  field(:ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V2.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
    enum: true
  )
  ...
  field(:explorer_auto_optimizer_setting, 21,
    type: Google.Ads.Googleads.V2.Common.ExplorerAutoOptimizerSetting
  )
  ...
  field(:targeting_setting, 25, type: Google.Ads.Googleads.V2.Common.TargetingSetting)
