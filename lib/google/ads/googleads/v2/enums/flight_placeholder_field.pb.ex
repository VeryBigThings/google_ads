defmodule Google.Ads.Googleads.V2.Enums.FlightPlaceholderFieldEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Enums.FlightPlaceholderFieldEnum.FlightPlaceholderField do
  @moduledoc false
