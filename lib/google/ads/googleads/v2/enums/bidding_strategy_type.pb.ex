defmodule Google.Ads.Googleads.V2.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
