defmodule Google.Ads.Googleads.V2.Enums.ConversionLagBucketEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Enums.ConversionLagBucketEnum.ConversionLagBucket do
  @moduledoc false
