defmodule Google.Ads.Googleads.V2.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
