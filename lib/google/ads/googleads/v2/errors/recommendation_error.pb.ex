defmodule Google.Ads.Googleads.V2.Errors.RecommendationErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
