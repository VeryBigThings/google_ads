defmodule Google.Ads.Googleads.V2.Errors.CampaignExperimentErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.CampaignExperimentErrorEnum.CampaignExperimentError do
  @moduledoc false
