defmodule Google.Ads.Googleads.V2.Errors.OperationAccessDeniedErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.OperationAccessDeniedErrorEnum.OperationAccessDeniedError do
  @moduledoc false
