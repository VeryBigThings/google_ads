defmodule Google.Ads.Googleads.V2.Errors.CustomInterestErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
