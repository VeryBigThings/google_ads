defmodule Google.Ads.Googleads.V2.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
