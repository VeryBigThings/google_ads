defmodule Google.Ads.Googleads.V2.Errors.CampaignErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.CampaignErrorEnum.CampaignError do
  @moduledoc false
  ...
  field(:MISSING_UNIVERSAL_APP_CAMPAIGN_SETTING, 30)
