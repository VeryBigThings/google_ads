defmodule Google.Ads.Googleads.V2.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
