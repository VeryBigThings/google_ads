defmodule Google.Ads.Googleads.V2.Errors.AccountBudgetProposalErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError do
  @moduledoc false
