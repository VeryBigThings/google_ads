defmodule Google.Ads.Googleads.V2.Errors.AuthenticationErrorEnum do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V2.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
