defmodule Google.Ads.Googleads.V8Availabilities.Errors.BatchJobErrorEnum.BatchJobError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V8Availabilities.Errors.BatchJobErrorEnum do
  @moduledoc false
