defmodule Google.Ads.Googleads.V8Availabilities.Errors.CampaignErrorEnum.CampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V8Availabilities.Errors.CampaignErrorEnum do
  @moduledoc false
