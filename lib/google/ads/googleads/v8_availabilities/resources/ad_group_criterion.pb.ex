defmodule Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          status:
            Google.Ads.Googleads.V8Availabilities.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus.t(),
          quality_info: Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.QualityInfo.t() | nil,
          ad_group: String.t(),
          type: Google.Ads.Googleads.V8Availabilities.Enums.CriterionTypeEnum.CriterionType.t(),
          negative: boolean,
          system_serving_status:
            Google.Ads.Googleads.V8Availabilities.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus.t(),
          approval_status:
            Google.Ads.Googleads.V8Availabilities.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus.t(),
          ...
          effective_percent_cpc_bid_source:
            Google.Ads.Googleads.V8Availabilities.Enums.BiddingSourceEnum.BiddingSource.t(),
          position_estimates:
            Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.PositionEstimates.t() | nil,
          final_urls: [String.t()],
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V8Availabilities.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4, type: Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.QualityInfo
  field :ad_group, 57, type: :string
  field :type, 25, type: Google.Ads.Googleads.V8Availabilities.Enums.CriterionTypeEnum.CriterionType, enum: true
  field :negative, 58, type: :bool

  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V8Availabilities.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
    enum: true

  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V8Availabilities.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
    enum: true
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V8Availabilities.Resources.AdGroupCriterion.PositionEstimates
  ...
  field :keyword, 27, type: Google.Ads.Googleads.V8Availabilities.Common.KeywordInfo, oneof: 0
  field :placement, 28, type: Google.Ads.Googleads.V8Availabilities.Common.PlacementInfo, oneof: 0
  ...
  field :listing_group, 32, type: Google.Ads.Googleads.V8Availabilities.Common.ListingGroupInfo, oneof: 0
  field :age_range, 36, type: Google.Ads.Googleads.V8Availabilities.Common.AgeRangeInfo, oneof: 0
  field :gender, 37, type: Google.Ads.Googleads.V8Availabilities.Common.GenderInfo, oneof: 0
  field :income_range, 38, type: Google.Ads.Googleads.V8Availabilities.Common.IncomeRangeInfo, oneof: 0
  field :parental_status, 39, type: Google.Ads.Googleads.V8Availabilities.Common.ParentalStatusInfo, oneof: 0
  field :user_list, 42, type: Google.Ads.Googleads.V8Availabilities.Common.UserListInfo, oneof: 0
  field :youtube_video, 40, type: Google.Ads.Googleads.V8Availabilities.Common.YouTubeVideoInfo, oneof: 0
  field :youtube_channel, 41, type: Google.Ads.Googleads.V8Availabilities.Common.YouTubeChannelInfo, oneof: 0
  field :topic, 43, type: Google.Ads.Googleads.V8Availabilities.Common.TopicInfo, oneof: 0
  field :user_interest, 45, type: Google.Ads.Googleads.V8Availabilities.Common.UserInterestInfo, oneof: 0
  field :webpage, 46, type: Google.Ads.Googleads.V8Availabilities.Common.WebpageInfo, oneof: 0
  field :app_payment_model, 47, type: Google.Ads.Googleads.V8Availabilities.Common.AppPaymentModelInfo, oneof: 0
  field :custom_affinity, 48, type: Google.Ads.Googleads.V8Availabilities.Common.CustomAffinityInfo, oneof: 0
  field :custom_intent, 49, type: Google.Ads.Googleads.V8Availabilities.Common.CustomIntentInfo, oneof: 0
  field :custom_audience, 74, type: Google.Ads.Googleads.V8Availabilities.Common.CustomAudienceInfo, oneof: 0
