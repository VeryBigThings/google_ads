defmodule Google.Ads.Googleads.V8Availabilities.Resources.AdGroupSimulation do
  @moduledoc false
  ...
  field :cpv_bid_point_list, 10,
    type: Google.Ads.Googleads.V8Availabilities.Common.CpvBidSimulationPointList,
    oneof: 0
