defmodule Google.Ads.Googleads.V8Availabilities.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V8Availabilities.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
