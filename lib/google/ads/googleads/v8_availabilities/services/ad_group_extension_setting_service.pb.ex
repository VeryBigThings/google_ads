...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupExtensionSettingsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.AdGroupExtensionSettingOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupExtensionSettingsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupExtensionSettingResult.t()]
        }
