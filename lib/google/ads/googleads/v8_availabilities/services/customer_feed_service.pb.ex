...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCustomerFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.CustomerFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCustomerFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateCustomerFeedResult.t()]
        }
