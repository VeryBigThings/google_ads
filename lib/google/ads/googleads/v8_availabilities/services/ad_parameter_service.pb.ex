...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdParametersRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.AdParameterOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdParametersResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateAdParameterResult.t()]
        }
