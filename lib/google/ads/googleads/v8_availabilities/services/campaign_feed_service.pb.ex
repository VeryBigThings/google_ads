...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.CampaignFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignFeedResult.t()]
        }
