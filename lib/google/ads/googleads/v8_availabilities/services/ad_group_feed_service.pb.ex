...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.AdGroupFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateAdGroupFeedResult.t()]
        }
