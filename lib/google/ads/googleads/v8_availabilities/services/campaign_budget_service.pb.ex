...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignBudgetsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.CampaignBudgetOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignBudgetsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignBudgetResult.t()]
        }
