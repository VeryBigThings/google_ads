...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignCriteriaRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.CampaignCriterionOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignCriteriaResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateCampaignCriterionResult.t()]
        }
