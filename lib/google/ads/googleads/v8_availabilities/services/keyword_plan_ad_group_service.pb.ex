...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateKeywordPlanAdGroupsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8Availabilities.Services.KeywordPlanAdGroupOperation.t()],
...
defmodule Google.Ads.Googleads.V8Availabilities.Services.MutateKeywordPlanAdGroupsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8Availabilities.Services.MutateKeywordPlanAdGroupResult.t()]
        }
