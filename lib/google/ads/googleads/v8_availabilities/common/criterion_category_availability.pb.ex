defmodule Google.Ads.Googleads.V8Availabilities.Common.CriterionCategoryAvailability do
  @moduledoc false
  ...
  field :locale, 2,
    repeated: true,
    type: Google.Ads.Googleads.V8Availabilities.Common.CriterionCategoryLocaleAvailability
end

defmodule Google.Ads.Googleads.V8Availabilities.Common.CriterionCategoryChannelAvailability do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :availability_mode, 1,
    type:
      Google.Ads.Googleads.V8Availabilities.Enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode,
    enum: true
...
defmodule Google.Ads.Googleads.V8Availabilities.Common.CriterionCategoryLocaleAvailability do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :availability_mode, 1,
    type:
      Google.Ads.Googleads.V8Availabilities.Enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode,
    enum: true
