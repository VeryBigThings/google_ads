defmodule Google.Ads.Googleads.V11.Services.MutateCustomerManagerLinkRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CustomerManagerLinkOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CustomerManagerLinkOperation do
  ...
  @type t :: %__MODULE__{
          operation: {:update, Google.Ads.Googleads.V11.Resources.CustomerManagerLink.t() | nil},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCustomerManagerLinkResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V11.Services.MutateCustomerManagerLinkResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CustomerManagerLinkService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CustomerManagerLinkService"
