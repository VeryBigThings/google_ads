defmodule Google.Ads.Googleads.V11.Services.MutateFeedItemsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.FeedItemOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.FeedItemOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.FeedItem.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.FeedItem.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateFeedItemsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateFeedItemResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.FeedItemService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.FeedItemService"
