defmodule Google.Ads.Googleads.V11.Services.MutateCustomerAssetsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CustomerAssetOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CustomerAssetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.CustomerAsset.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.CustomerAsset.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCustomerAssetsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateCustomerAssetResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CustomerAssetService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CustomerAssetService"
