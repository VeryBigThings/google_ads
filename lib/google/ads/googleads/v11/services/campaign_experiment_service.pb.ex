defmodule Google.Ads.Googleads.V11.Services.MutateCampaignExperimentsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CampaignExperimentOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CampaignExperimentOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:update, Google.Ads.Googleads.V11.Resources.CampaignExperiment.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCampaignExperimentsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateCampaignExperimentResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CampaignExperimentService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CampaignExperimentService"
