defmodule Google.Ads.Googleads.V11.Services.MutateExtensionFeedItemsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.ExtensionFeedItemOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.ExtensionFeedItemOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.ExtensionFeedItem.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.ExtensionFeedItem.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateExtensionFeedItemsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateExtensionFeedItemResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.ExtensionFeedItemService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.ExtensionFeedItemService"
