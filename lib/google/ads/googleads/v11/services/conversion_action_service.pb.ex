defmodule Google.Ads.Googleads.V11.Services.MutateConversionActionsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.ConversionActionOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.ConversionActionOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.ConversionAction.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.ConversionAction.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateConversionActionsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateConversionActionResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.ConversionActionService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.ConversionActionService"
