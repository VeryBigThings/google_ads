defmodule Google.Ads.Googleads.V11.Services.MutateCustomerConversionGoalsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CustomerConversionGoalOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CustomerConversionGoalOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:update, Google.Ads.Googleads.V11.Resources.CustomerConversionGoal.t() | nil},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCustomerConversionGoalsResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V11.Services.MutateCustomerConversionGoalResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CustomerConversionGoalService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CustomerConversionGoalService"
