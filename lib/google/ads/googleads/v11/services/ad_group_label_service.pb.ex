defmodule Google.Ads.Googleads.V11.Services.MutateAdGroupLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.AdGroupLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.AdGroupLabelOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.AdGroupLabel.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V11.Services.MutateAdGroupLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateAdGroupLabelResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.AdGroupLabelService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.AdGroupLabelService"
