defmodule Google.Ads.Googleads.V11.Services.MutateCustomerUserAccessInvitationRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operation:
            Google.Ads.Googleads.V11.Services.CustomerUserAccessInvitationOperation.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.CustomerUserAccessInvitationOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.CustomerUserAccessInvitation.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V11.Services.MutateCustomerUserAccessInvitationResponse do
  ...
  @type t :: %__MODULE__{
          result:
            Google.Ads.Googleads.V11.Services.MutateCustomerUserAccessInvitationResult.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.CustomerUserAccessInvitationService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CustomerUserAccessInvitationService"
