defmodule Google.Ads.Googleads.V11.Services.MutateMediaFilesRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.MediaFileOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.MediaFileOperation do
  ...
  @type t :: %__MODULE__{
          operation: {:create, Google.Ads.Googleads.V11.Resources.MediaFile.t() | nil}
        }
...
defmodule Google.Ads.Googleads.V11.Services.MutateMediaFilesResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateMediaFileResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.MediaFileService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.MediaFileService"
