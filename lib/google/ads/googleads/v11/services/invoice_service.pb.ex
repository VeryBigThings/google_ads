defmodule Google.Ads.Googleads.V11.Services.ListInvoicesRequest do
  ...
  @type t :: %__MODULE__{
          ...
          issue_year: String.t(),
          issue_month: Google.Ads.Googleads.V11.Enums.MonthOfYearEnum.MonthOfYear.t()
        }
...
defmodule Google.Ads.Googleads.V11.Services.ListInvoicesResponse do
  ...
  @type t :: %__MODULE__{
          invoices: [Google.Ads.Googleads.V11.Resources.Invoice.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.InvoiceService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.InvoiceService"
