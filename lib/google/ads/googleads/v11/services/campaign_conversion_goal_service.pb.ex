defmodule Google.Ads.Googleads.V11.Services.MutateCampaignConversionGoalsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CampaignConversionGoalOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CampaignConversionGoalOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:update, Google.Ads.Googleads.V11.Resources.CampaignConversionGoal.t() | nil},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCampaignConversionGoalsResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V11.Services.MutateCampaignConversionGoalResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CampaignConversionGoalService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CampaignConversionGoalService"
