defmodule Google.Ads.Googleads.V11.Services.MutateCampaignFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CampaignFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CampaignFeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.CampaignFeed.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.CampaignFeed.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateCampaignFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateCampaignFeedResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CampaignFeedService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CampaignFeedService"
