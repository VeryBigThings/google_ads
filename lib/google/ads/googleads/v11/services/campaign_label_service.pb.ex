defmodule Google.Ads.Googleads.V11.Services.MutateCampaignLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.CampaignLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.CampaignLabelOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.CampaignLabel.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V11.Services.MutateCampaignLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateCampaignLabelResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.CampaignLabelService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.CampaignLabelService"
