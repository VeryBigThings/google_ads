defmodule Google.Ads.Googleads.V11.Services.MutateFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V11.Services.FeedOperation.t()],
...
defmodule Google.Ads.Googleads.V11.Services.FeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.Feed.t() | nil}
            | {:update, Google.Ads.Googleads.V11.Resources.Feed.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V11.Services.MutateFeedResult.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.FeedService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.FeedService"
