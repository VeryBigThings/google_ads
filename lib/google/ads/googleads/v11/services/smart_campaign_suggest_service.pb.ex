defmodule Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsRequest do
  ...
  @type t :: %__MODULE__{
          suggestion_data:
            {:campaign, String.t()}
            | {:suggestion_info,
               Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo.t() | nil},
...
defmodule Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo.LocationList do
  ...
  @type t :: %__MODULE__{
          locations: [Google.Ads.Googleads.V11.Common.LocationInfo.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo do
  ...
  @type t :: %__MODULE__{
          business_setting:
            {:business_context,
             Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo.BusinessContext.t()
             | nil}
            | {:business_profile_location, String.t()},
          geo_target:
            {:location_list,
             Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo.LocationList.t() | nil}
          ...
          keyword_themes: [Google.Ads.Googleads.V11.Common.KeywordThemeInfo.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption do
  ...
  @type t :: %__MODULE__{
          ...
          metrics:
            Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsResponse.Metrics.t()
            | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsResponse do
  ...
  @type t :: %__MODULE__{
          low:
            Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption.t()
            | nil,
          recommended:
            Google.Ads.Googleads.V11.Services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption.t()
            | nil,
...
defmodule Google.Ads.Googleads.V11.Services.SuggestSmartCampaignAdRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          suggestion_info: Google.Ads.Googleads.V11.Services.SmartCampaignSuggestionInfo.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.SuggestSmartCampaignAdResponse do
  ...
  @type t :: %__MODULE__{
          ad_info: Google.Ads.Googleads.V11.Common.SmartCampaignAdInfo.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.SuggestKeywordThemesResponse do
  ...
  @type t :: %__MODULE__{
          keyword_themes: [Google.Ads.Googleads.V11.Resources.KeywordThemeConstant.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Services.SmartCampaignSuggestService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.SmartCampaignSuggestService"
