defmodule Google.Ads.Googleads.V11.Services.MutateAccountBudgetProposalRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operation: Google.Ads.Googleads.V11.Services.AccountBudgetProposalOperation.t() | nil,
...
defmodule Google.Ads.Googleads.V11.Services.AccountBudgetProposalOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V11.Resources.AccountBudgetProposal.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V11.Services.MutateAccountBudgetProposalResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Ads.Googleads.V11.Services.MutateAccountBudgetProposalResult.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Services.AccountBudgetProposalService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v11.services.AccountBudgetProposalService"
