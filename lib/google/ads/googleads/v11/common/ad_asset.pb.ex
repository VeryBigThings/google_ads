defmodule Google.Ads.Googleads.V11.Common.AdTextAsset do
  ...
  @type t :: %__MODULE__{
          text: String.t(),
          pinned_field:
            Google.Ads.Googleads.V11.Enums.ServedAssetFieldTypeEnum.ServedAssetFieldType.t(),
          asset_performance_label:
            Google.Ads.Googleads.V11.Enums.AssetPerformanceLabelEnum.AssetPerformanceLabel.t(),
          policy_summary_info: Google.Ads.Googleads.V11.Common.AdAssetPolicySummary.t() | nil
        }
