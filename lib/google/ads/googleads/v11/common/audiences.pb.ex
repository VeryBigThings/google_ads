defmodule Google.Ads.Googleads.V11.Common.AudienceDimension do
  ...
  @type t :: %__MODULE__{
          dimension:
            {:age, Google.Ads.Googleads.V11.Common.AgeDimension.t() | nil}
            | {:gender, Google.Ads.Googleads.V11.Common.GenderDimension.t() | nil}
            | {:household_income,
               Google.Ads.Googleads.V11.Common.HouseholdIncomeDimension.t() | nil}
            | {:parental_status,
               Google.Ads.Googleads.V11.Common.ParentalStatusDimension.t() | nil}
            | {:audience_segments,
               Google.Ads.Googleads.V11.Common.AudienceSegmentDimension.t() | nil}
        }
...
defmodule Google.Ads.Googleads.V11.Common.AudienceExclusionDimension do
  ...
  @type t :: %__MODULE__{
          exclusions: [Google.Ads.Googleads.V11.Common.ExclusionSegment.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Common.ExclusionSegment do
  ...
  @type t :: %__MODULE__{
          segment: {:user_list, Google.Ads.Googleads.V11.Common.UserListSegment.t() | nil}
        }
...
defmodule Google.Ads.Googleads.V11.Common.AgeDimension do
  ...
  @type t :: %__MODULE__{
          age_ranges: [Google.Ads.Googleads.V11.Common.AgeSegment.t()],
...
defmodule Google.Ads.Googleads.V11.Common.GenderDimension do
  ...
  @type t :: %__MODULE__{
          genders: [Google.Ads.Googleads.V11.Enums.GenderTypeEnum.GenderType.t()],
          include_undetermined: boolean
        }
...
defmodule Google.Ads.Googleads.V11.Common.HouseholdIncomeDimension do
  ...
  @type t :: %__MODULE__{
          income_ranges: [Google.Ads.Googleads.V11.Enums.IncomeRangeTypeEnum.IncomeRangeType.t()],
          include_undetermined: boolean
        }
...
defmodule Google.Ads.Googleads.V11.Common.ParentalStatusDimension do
  ...
  @type t :: %__MODULE__{
          parental_statuses: [
            Google.Ads.Googleads.V11.Enums.ParentalStatusTypeEnum.ParentalStatusType.t()
          ],
          include_undetermined: boolean
        }
...
defmodule Google.Ads.Googleads.V11.Common.AudienceSegmentDimension do
  ...
  @type t :: %__MODULE__{
          segments: [Google.Ads.Googleads.V11.Common.AudienceSegment.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Common.AudienceSegment do
  ...
  @type t :: %__MODULE__{
          segment:
            {:user_list, Google.Ads.Googleads.V11.Common.UserListSegment.t() | nil}
            | {:user_interest, Google.Ads.Googleads.V11.Common.UserInterestSegment.t() | nil}
            | {:life_event, Google.Ads.Googleads.V11.Common.LifeEventSegment.t() | nil}
            | {:detailed_demographic,
               Google.Ads.Googleads.V11.Common.DetailedDemographicSegment.t() | nil}
            | {:custom_audience, Google.Ads.Googleads.V11.Common.CustomAudienceSegment.t() | nil}
        }
