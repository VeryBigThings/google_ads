...
defmodule Google.Ads.Googleads.V11.Common.ImageAsset do
  ...
  @type t :: %__MODULE__{
          ...
          full_size: Google.Ads.Googleads.V11.Common.ImageDimension.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormAsset do
  ...
  @type t :: %__MODULE__{
          ...
          call_to_action_type:
            Google.Ads.Googleads.V11.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType.t(),
          ...
          fields: [Google.Ads.Googleads.V11.Common.LeadFormField.t()],
          custom_question_fields: [
            Google.Ads.Googleads.V11.Common.LeadFormCustomQuestionField.t()
          ],
          delivery_methods: [Google.Ads.Googleads.V11.Common.LeadFormDeliveryMethod.t()],
          post_submit_call_to_action_type:
            Google.Ads.Googleads.V11.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType.t(),
          background_image_asset: String.t(),
          desired_intent:
            Google.Ads.Googleads.V11.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent.t(),
  ...
  @type t :: %__MODULE__{
          answers:
            {:single_choice_answers,
             Google.Ads.Googleads.V11.Common.LeadFormSingleChoiceAnswers.t() | nil},
          input_type:
            Google.Ads.Googleads.V11.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType.t()
        }
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormDeliveryMethod do
  ...
  @type t :: %__MODULE__{
          delivery_details: {:webhook, Google.Ads.Googleads.V11.Common.WebhookDelivery.t() | nil}
        }
...
defmodule Google.Ads.Googleads.V11.Common.PromotionAsset do
  ...
  @type t :: %__MODULE__{
          discount_type:
            {:percent_off, integer}
            | {:money_amount_off, Google.Ads.Googleads.V11.Common.Money.t() | nil},
          promotion_trigger:
            {:promotion_code, String.t()}
            | {:orders_over_amount, Google.Ads.Googleads.V11.Common.Money.t() | nil},
          promotion_target: String.t(),
          discount_modifier:
            Google.Ads.Googleads.V11.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier.t(),
          redemption_start_date: String.t(),
          redemption_end_date: String.t(),
          occasion:
            Google.Ads.Googleads.V11.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion.t(),
          language_code: String.t(),
          start_date: String.t(),
          end_date: String.t(),
          ad_schedule_targets: [Google.Ads.Googleads.V11.Common.AdScheduleInfo.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Common.MobileAppAsset do
  ...
  @type t :: %__MODULE__{
          app_id: String.t(),
          app_store: Google.Ads.Googleads.V11.Enums.MobileAppVendorEnum.MobileAppVendor.t(),
          link_text: String.t(),
          start_date: String.t(),
          end_date: String.t()
        }
...
defmodule Google.Ads.Googleads.V11.Common.PriceAsset do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V11.Enums.PriceExtensionTypeEnum.PriceExtensionType.t(),
          price_qualifier:
            Google.Ads.Googleads.V11.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier.t(),
          language_code: String.t(),
          price_offerings: [Google.Ads.Googleads.V11.Common.PriceOffering.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Common.PriceOffering do
  ...
  @type t :: %__MODULE__{
          header: String.t(),
          description: String.t(),
          price: Google.Ads.Googleads.V11.Common.Money.t() | nil,
          unit:
            Google.Ads.Googleads.V11.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit.t(),
          final_url: String.t(),
...
defmodule Google.Ads.Googleads.V11.Common.CallToActionAsset do
  ...
  @type t :: %__MODULE__{
          call_to_action: Google.Ads.Googleads.V11.Enums.CallToActionTypeEnum.CallToActionType.t()
        }
...
defmodule Google.Ads.Googleads.V11.Common.DynamicRealEstateAsset do
  ...
  @type t :: %__MODULE__{
          ...
          listing_type: String.t(),
          contextual_keywords: [String.t()],
          formatted_price: String.t(),
          android_app_link: String.t(),
          ios_app_link: String.t(),
          ios_app_store_id: integer,
          similar_listing_ids: [String.t()]
        }

  defstruct listing_id: "",
            listing_name: "",
            city_name: "",
            description: "",
            address: "",
...
defmodule Google.Ads.Googleads.V11.Common.DynamicCustomAsset do
  ...
  @type t :: %__MODULE__{
          ...
          id2: String.t(),
          item_title: String.t(),
          item_subtitle: String.t(),
          item_description: String.t(),
          item_address: String.t(),
          item_category: String.t(),
          price: String.t(),
          sale_price: String.t(),
          formatted_price: String.t(),
          formatted_sale_price: String.t(),
          image_url: String.t(),
          contextual_keywords: [String.t()],
          android_app_link: String.t(),
          ios_app_link: String.t(),
          ios_app_store_id: integer,
          similar_ids: [String.t()]
        }
...
defmodule Google.Ads.Googleads.V11.Common.DynamicFlightsAsset do
  ...
  @type t :: %__MODULE__{
          ...
          origin_id: String.t(),
          flight_description: String.t(),
          image_url: String.t(),
          destination_name: String.t(),
          origin_name: String.t(),
          flight_price: String.t(),
          flight_sale_price: String.t(),
          formatted_price: String.t(),
          formatted_sale_price: String.t(),
          android_app_link: String.t(),
          ios_app_link: String.t(),
          ios_app_store_id: integer,
          similar_destination_ids: [String.t()],
          custom_mapping: String.t()
        }

  defstruct destination_id: "",
            origin_id: "",
            flight_description: "",
            image_url: "",
            destination_name: "",
...
defmodule Google.Ads.Googleads.V11.Common.DiscoveryCarouselCardAsset do
  ...
  @type t :: %__MODULE__{
          marketing_image_asset: String.t(),
          square_marketing_image_asset: String.t(),
          portrait_marketing_image_asset: String.t(),
          headline: String.t(),
          call_to_action_text: String.t()
        }

  defstruct marketing_image_asset: "",
...
defmodule Google.Ads.Googleads.V11.Common.DynamicJobsAsset do
  ...
  @type t :: %__MODULE__{
          ...
          location_id: String.t(),
          job_title: String.t(),
          job_subtitle: String.t(),
          description: String.t(),
          image_url: String.t(),
          job_category: String.t(),
          contextual_keywords: [String.t()],
          address: String.t(),
          salary: String.t(),
          android_app_link: String.t(),
          similar_job_ids: [String.t()],
          ios_app_link: String.t(),
          ios_app_store_id: integer
        }
