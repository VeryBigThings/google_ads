defmodule Google.Ads.Googleads.V11.Resources.BiddingSeasonalityAdjustment do
  ...
  @type t :: %__MODULE__{
          ...
          scope:
            Google.Ads.Googleads.V11.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope.t(),
          status:
            Google.Ads.Googleads.V11.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus.t(),
          start_date_time: String.t(),
          end_date_time: String.t(),
          name: String.t(),
          description: String.t(),
          devices: [Google.Ads.Googleads.V11.Enums.DeviceEnum.Device.t()],
