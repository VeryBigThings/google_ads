defmodule Google.Ads.Googleads.V11.Resources.Invoice.AccountBudgetSummary do
  ...
  @type t :: %__MODULE__{
          ...
          billable_activity_date_range: Google.Ads.Googleads.V11.Common.DateRange.t() | nil
        }
...
defmodule Google.Ads.Googleads.V11.Resources.Invoice do
  ...
  @type t :: %__MODULE__{
          ...
          id: String.t(),
          type: Google.Ads.Googleads.V11.Enums.InvoiceTypeEnum.InvoiceType.t(),
          billing_setup: String.t(),
          payments_account_id: String.t(),
          payments_profile_id: String.t(),
          issue_date: String.t(),
          due_date: String.t(),
          service_date_range: Google.Ads.Googleads.V11.Common.DateRange.t() | nil,
          ...
          account_budget_summaries: [
            Google.Ads.Googleads.V11.Resources.Invoice.AccountBudgetSummary.t()
          ]
        }
