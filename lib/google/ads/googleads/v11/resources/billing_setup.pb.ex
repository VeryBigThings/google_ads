...
defmodule Google.Ads.Googleads.V11.Resources.BillingSetup do
  ...
  @type t :: %__MODULE__{
          start_time:
            ...
            | {:start_time_type, Google.Ads.Googleads.V11.Enums.TimeTypeEnum.TimeType.t()},
          end_time:
            {:end_date_time, String.t()}
            | {:end_time_type, Google.Ads.Googleads.V11.Enums.TimeTypeEnum.TimeType.t()},
          resource_name: String.t(),
          id: integer,
          status: Google.Ads.Googleads.V11.Enums.BillingSetupStatusEnum.BillingSetupStatus.t(),
          payments_account: String.t(),
          payments_account_info:
            Google.Ads.Googleads.V11.Resources.BillingSetup.PaymentsAccountInfo.t() | nil
        }
