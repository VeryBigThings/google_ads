defmodule Google.Ads.Googleads.V11.Resources.Audience do
  ...
  @type t :: %__MODULE__{
          ...
          id: integer,
          status: Google.Ads.Googleads.V11.Enums.AudienceStatusEnum.AudienceStatus.t(),
          name: String.t(),
          description: String.t(),
          dimensions: [Google.Ads.Googleads.V11.Common.AudienceDimension.t()],
          exclusion_dimension:
            Google.Ads.Googleads.V11.Common.AudienceExclusionDimension.t() | nil
        }
