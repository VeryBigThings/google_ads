defmodule Google.Ads.Googleads.V11.Resources.CallView do
  ...
  @type t :: %__MODULE__{
          ...
          call_tracking_display_location:
            Google.Ads.Googleads.V11.Enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation.t(),
          type: Google.Ads.Googleads.V11.Enums.CallTypeEnum.CallType.t(),
          call_status:
            Google.Ads.Googleads.V11.Enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus.t()
        }
