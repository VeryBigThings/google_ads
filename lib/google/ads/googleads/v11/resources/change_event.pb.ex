...
defmodule Google.Ads.Googleads.V11.Resources.ChangeEvent do
  ...
  @type t :: %__MODULE__{
          ...
          change_resource_type:
            Google.Ads.Googleads.V11.Enums.ChangeEventResourceTypeEnum.ChangeEventResourceType.t(),
          change_resource_name: String.t(),
          client_type: Google.Ads.Googleads.V11.Enums.ChangeClientTypeEnum.ChangeClientType.t(),
          user_email: String.t(),
          old_resource: Google.Ads.Googleads.V11.Resources.ChangeEvent.ChangedResource.t() | nil,
          new_resource: Google.Ads.Googleads.V11.Resources.ChangeEvent.ChangedResource.t() | nil,
          resource_change_operation:
            Google.Ads.Googleads.V11.Enums.ResourceChangeOperationEnum.ResourceChangeOperation.t(),
