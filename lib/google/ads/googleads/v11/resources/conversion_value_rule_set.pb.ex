defmodule Google.Ads.Googleads.V11.Resources.ConversionValueRuleSet do
  ...
  @type t :: %__MODULE__{
          ...
          dimensions: [
            Google.Ads.Googleads.V11.Enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension.t()
          ],
          owner_customer: String.t(),
          attachment_type:
            Google.Ads.Googleads.V11.Enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType.t(),
          campaign: String.t(),
          status:
            Google.Ads.Googleads.V11.Enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus.t(),
