...
defmodule Google.Ads.Googleads.V11.Resources.AdGroupCriterion do
  ...
  @type t :: %__MODULE__{
          criterion:
            ...
            | {:listing_group, Google.Ads.Googleads.V11.Common.ListingGroupInfo.t() | nil}
            ...
            | {:app_payment_model, Google.Ads.Googleads.V11.Common.AppPaymentModelInfo.t() | nil}
            | {:custom_affinity, Google.Ads.Googleads.V11.Common.CustomAffinityInfo.t() | nil}
            | {:custom_intent, Google.Ads.Googleads.V11.Common.CustomIntentInfo.t() | nil}
            ...
            | {:audience, Google.Ads.Googleads.V11.Common.AudienceInfo.t() | nil},
          resource_name: String.t(),
          criterion_id: integer,
          display_name: String.t(),
          status:
            Google.Ads.Googleads.V11.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus.t(),
          quality_info: Google.Ads.Googleads.V11.Resources.AdGroupCriterion.QualityInfo.t() | nil,
          ad_group: String.t(),
          type: Google.Ads.Googleads.V11.Enums.CriterionTypeEnum.CriterionType.t(),
          negative: boolean,
          system_serving_status:
            Google.Ads.Googleads.V11.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus.t(),
          approval_status:
            Google.Ads.Googleads.V11.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus.t(),
          ...
          effective_percent_cpc_bid_source:
            Google.Ads.Googleads.V11.Enums.BiddingSourceEnum.BiddingSource.t(),
          position_estimates:
            Google.Ads.Googleads.V11.Resources.AdGroupCriterion.PositionEstimates.t() | nil,
          final_urls: [String.t()],
