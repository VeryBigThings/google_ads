defmodule Google.Ads.Googleads.V11.Resources.Experiment do
  ...
  @type t :: %__MODULE__{
          ...
          suffix: String.t(),
          type: Google.Ads.Googleads.V11.Enums.ExperimentTypeEnum.ExperimentType.t(),
          status: Google.Ads.Googleads.V11.Enums.ExperimentStatusEnum.ExperimentStatus.t(),
          start_date: String.t(),
          end_date: String.t(),
          goals: [Google.Ads.Googleads.V11.Common.MetricGoal.t()],
          long_running_operation: String.t(),
          promote_status:
            Google.Ads.Googleads.V11.Enums.AsyncActionStatusEnum.AsyncActionStatus.t()
        }
