defmodule Google.Ads.Googleads.V16.Resources.Invoice.AccountSummary do
  ...
  field :tax_amount_micros, 15, type: :int64, json_name: "taxAmountMicros", deprecated: false
  field :total_amount_micros, 16, type: :int64, json_name: "totalAmountMicros", deprecated: false
end
...
defmodule Google.Ads.Googleads.V16.Resources.Invoice.InvalidActivitySummary do
  ...
  field :original_invoice_id, 3, type: :string, json_name: "originalInvoiceId", deprecated: false
  ...
  field :amount_micros, 6, type: :int64, json_name: "amountMicros", deprecated: false
end
