defmodule Google.Ads.Googleads.V7.Common.KeywordPlanHistoricalMetrics do
  ...
  @type t :: %__MODULE__{
          ...
          monthly_search_volumes: [Google.Ads.Googleads.V7.Common.MonthlySearchVolume.t()],
          competition:
            Google.Ads.Googleads.V7.Enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel.t(),
...
defmodule Google.Ads.Googleads.V7.Common.HistoricalMetricsOptions do
  ...
  @type t :: %__MODULE__{
          year_month_range: Google.Ads.Googleads.V7.Common.YearMonthRange.t() | nil
        }
...
defmodule Google.Ads.Googleads.V7.Common.MonthlySearchVolume do
  ...
  @type t :: %__MODULE__{
          year: integer,
          month: Google.Ads.Googleads.V7.Enums.MonthOfYearEnum.MonthOfYear.t(),
...
defmodule Google.Ads.Googleads.V7.Common.KeywordPlanAggregateMetrics do
  ...
  @type t :: %__MODULE__{
          aggregate_metric_types: [
            [
              Google.Ads.Googleads.V7.Enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType.t()
            ]
          ]
        }
...
defmodule Google.Ads.Googleads.V7.Common.KeywordPlanAggregateMetricResults do
  ...
  @type t :: %__MODULE__{
          device_searches: [Google.Ads.Googleads.V7.Common.KeywordPlanDeviceSearches.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Common.KeywordAnnotations do
  ...
  @type t :: %__MODULE__{
          concepts: [Google.Ads.Googleads.V7.Common.KeywordConcept.t()]
        }
  defstruct [:concepts]
...
defmodule Google.Ads.Googleads.V7.Common.KeywordConcept do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          concept_group: Google.Ads.Googleads.V7.Common.ConceptGroup.t() | nil
        }
...
defmodule Google.Ads.Googleads.V7.Common.ConceptGroup do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          type:
            Google.Ads.Googleads.V7.Enums.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType.t()
        }
  defstruct [:name, :type]
