defmodule Google.Ads.Googleads.V7.Common.Segments do
  ...
  @type t :: %__MODULE__{
          ad_destination_type:
            Google.Ads.Googleads.V7.Enums.AdDestinationTypeEnum.AdDestinationType.t(),
          ad_network_type: Google.Ads.Googleads.V7.Enums.AdNetworkTypeEnum.AdNetworkType.t(),
          budget_campaign_association_status:
            Google.Ads.Googleads.V7.Common.BudgetCampaignAssociationStatus.t() | nil,
          click_type: Google.Ads.Googleads.V7.Enums.ClickTypeEnum.ClickType.t(),
          ...
          conversion_attribution_event_type:
            Google.Ads.Googleads.V7.Enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType.t(),
          conversion_lag_bucket:
            Google.Ads.Googleads.V7.Enums.ConversionLagBucketEnum.ConversionLagBucket.t(),
          conversion_or_adjustment_lag_bucket:
            Google.Ads.Googleads.V7.Enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket.t(),
          date: String.t(),
          day_of_week: Google.Ads.Googleads.V7.Enums.DayOfWeekEnum.DayOfWeek.t(),
          device: Google.Ads.Googleads.V7.Enums.DeviceEnum.Device.t(),
          external_conversion_source:
            Google.Ads.Googleads.V7.Enums.ExternalConversionSourceEnum.ExternalConversionSource.t(),
          ...
          hotel_check_in_day_of_week: Google.Ads.Googleads.V7.Enums.DayOfWeekEnum.DayOfWeek.t(),
          hotel_city: String.t(),
          hotel_class: integer,
          ...
          hotel_rate_type: Google.Ads.Googleads.V7.Enums.HotelRateTypeEnum.HotelRateType.t(),
          hotel_price_bucket:
            Google.Ads.Googleads.V7.Enums.HotelPriceBucketEnum.HotelPriceBucket.t(),
          hotel_state: String.t(),
          hour: integer,
          interaction_on_this_extension: boolean,
          keyword: Google.Ads.Googleads.V7.Common.Keyword.t() | nil,
          month: String.t(),
          month_of_year: Google.Ads.Googleads.V7.Enums.MonthOfYearEnum.MonthOfYear.t(),
          ...
          product_channel: Google.Ads.Googleads.V7.Enums.ProductChannelEnum.ProductChannel.t(),
          product_channel_exclusivity:
            Google.Ads.Googleads.V7.Enums.ProductChannelExclusivityEnum.ProductChannelExclusivity.t(),
          product_condition:
            Google.Ads.Googleads.V7.Enums.ProductConditionEnum.ProductCondition.t(),
          ...
          search_engine_results_page_type:
            Google.Ads.Googleads.V7.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType.t(),
          search_term_match_type:
            Google.Ads.Googleads.V7.Enums.SearchTermMatchTypeEnum.SearchTermMatchType.t(),
          slot: Google.Ads.Googleads.V7.Enums.SlotEnum.Slot.t(),
          webpage: String.t(),
          week: String.t(),
          year: integer,
...
defmodule Google.Ads.Googleads.V7.Common.Keyword do
  ...
  @type t :: %__MODULE__{
          ...
          info: Google.Ads.Googleads.V7.Common.KeywordInfo.t() | nil
        }
...
defmodule Google.Ads.Googleads.V7.Common.BudgetCampaignAssociationStatus do
  ...
  @type t :: %__MODULE__{
          campaign: String.t(),
          status:
            Google.Ads.Googleads.V7.Enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus.t()
        }
