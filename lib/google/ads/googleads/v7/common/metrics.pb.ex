defmodule Google.Ads.Googleads.V7.Common.Metrics do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          interaction_event_types: [
            [Google.Ads.Googleads.V7.Enums.InteractionEventTypeEnum.InteractionEventType.t()]
          ],
  ...
  field :interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V7.Enums.InteractionEventTypeEnum.InteractionEventType,
    enum: true
