...
defmodule Google.Ads.Googleads.V7.Services.ApplyRecommendationRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.ApplyRecommendationOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.ApplyRecommendationOperation.CalloutExtensionParameters do
  ...
  @type t :: %__MODULE__{
          callout_extensions: [Google.Ads.Googleads.V7.Common.CalloutFeedItem.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Services.ApplyRecommendationOperation.CallExtensionParameters do
  ...
  @type t :: %__MODULE__{
          call_extensions: [Google.Ads.Googleads.V7.Common.CallFeedItem.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Services.ApplyRecommendationOperation.SitelinkExtensionParameters do
  ...
  @type t :: %__MODULE__{
          sitelink_extensions: [Google.Ads.Googleads.V7.Common.SitelinkFeedItem.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Services.ApplyRecommendationResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V7.Services.ApplyRecommendationResult.t()],
...
defmodule Google.Ads.Googleads.V7.Services.DismissRecommendationRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          operations: [
            Google.Ads.Googleads.V7.Services.DismissRecommendationRequest.DismissRecommendationOperation.t()
          ],
          partial_failure: boolean
        }
  defstruct [:customer_id, :operations, :partial_failure]
...
defmodule Google.Ads.Googleads.V7.Services.DismissRecommendationResponse do
  ...
  @type t :: %__MODULE__{
          results: [
            Google.Ads.Googleads.V7.Services.DismissRecommendationResponse.DismissRecommendationResult.t()
          ],
          partial_failure_error: Google.Rpc.Status.t() | nil
        }
  defstruct [:results, :partial_failure_error]
