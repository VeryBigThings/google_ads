defmodule Google.Ads.Googleads.V7.Resources.CampaignExperiment do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          traffic_split_type:
            Google.Ads.Googleads.V7.Enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType.t(),
          experiment_campaign: String.t(),
          status:
            Google.Ads.Googleads.V7.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus.t(),
  ...
  field :status, 9,
    type: Google.Ads.Googleads.V7.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus,
    enum: true
