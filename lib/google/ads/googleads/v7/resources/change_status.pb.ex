defmodule Google.Ads.Googleads.V7.Resources.ChangeStatus do
  ...
  @type t :: %__MODULE__{
          ...
          resource_type:
            Google.Ads.Googleads.V7.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType.t(),
          campaign: String.t(),
          ad_group: String.t(),
          resource_status:
            Google.Ads.Googleads.V7.Enums.ChangeStatusOperationEnum.ChangeStatusOperation.t(),
