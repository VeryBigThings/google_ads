defmodule Google.Ads.Googleads.V7.Resources.ExtensionFeedItem do
  ...
  @type t :: %__MODULE__{
          ...
          ad_schedules: [Google.Ads.Googleads.V7.Common.AdScheduleInfo.t()],
          device: Google.Ads.Googleads.V7.Enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice.t(),
          targeted_geo_target_constant: String.t(),
          targeted_keyword: Google.Ads.Googleads.V7.Common.KeywordInfo.t() | nil,
