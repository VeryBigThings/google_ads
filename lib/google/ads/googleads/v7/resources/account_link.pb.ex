defmodule Google.Ads.Googleads.V7.Resources.AccountLink do
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V7.Enums.AccountLinkStatusEnum.AccountLinkStatus.t(),
          type: Google.Ads.Googleads.V7.Enums.LinkedAccountTypeEnum.LinkedAccountType.t()
        }
...
defmodule Google.Ads.Googleads.V7.Resources.ThirdPartyAppAnalyticsLinkIdentifier do
  ...
  @type t :: %__MODULE__{
          ...
          app_id: String.t(),
          app_vendor: Google.Ads.Googleads.V7.Enums.MobileAppVendorEnum.MobileAppVendor.t()
        }
