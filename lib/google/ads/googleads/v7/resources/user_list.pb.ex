defmodule Google.Ads.Googleads.V7.Resources.UserList do
  ...
  @type t :: %__MODULE__{
          ...
          membership_status:
            Google.Ads.Googleads.V7.Enums.UserListMembershipStatusEnum.UserListMembershipStatus.t(),
          integration_code: String.t(),
          membership_life_span: integer,
          size_for_display: integer,
          size_range_for_display:
            Google.Ads.Googleads.V7.Enums.UserListSizeRangeEnum.UserListSizeRange.t(),
          size_for_search: integer,
          size_range_for_search:
            Google.Ads.Googleads.V7.Enums.UserListSizeRangeEnum.UserListSizeRange.t(),
          type: Google.Ads.Googleads.V7.Enums.UserListTypeEnum.UserListType.t(),
          closing_reason:
            Google.Ads.Googleads.V7.Enums.UserListClosingReasonEnum.UserListClosingReason.t(),
          access_reason: Google.Ads.Googleads.V7.Enums.AccessReasonEnum.AccessReason.t(),
          account_user_list_status:
            Google.Ads.Googleads.V7.Enums.UserListAccessStatusEnum.UserListAccessStatus.t(),
