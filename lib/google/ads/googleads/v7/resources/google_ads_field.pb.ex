defmodule Google.Ads.Googleads.V7.Resources.GoogleAdsField do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          category:
            Google.Ads.Googleads.V7.Enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory.t(),
          selectable: boolean,
          filterable: boolean,
          sortable: boolean,
          ...
          data_type:
            Google.Ads.Googleads.V7.Enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType.t(),
          type_url: String.t(),
          is_repeated: boolean
        }
  defstruct [
  ...
  field :category, 3,
    type: Google.Ads.Googleads.V7.Enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory,
    enum: true
  ...
  field :data_type, 12,
    type: Google.Ads.Googleads.V7.Enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType,
    enum: true
