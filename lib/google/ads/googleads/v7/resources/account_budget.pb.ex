defmodule Google.Ads.Googleads.V7.Resources.AccountBudget.PendingAccountBudgetProposal do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Resources.AccountBudget do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V7.Enums.AccountBudgetStatusEnum.AccountBudgetStatus.t(),
          name: String.t(),
          ...
          notes: String.t(),
          pending_proposal:
            Google.Ads.Googleads.V7.Resources.AccountBudget.PendingAccountBudgetProposal.t() | nil
        }
  defstruct [
    :proposed_end_time,
    :approved_end_time,
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V7.Enums.AccountBudgetStatusEnum.AccountBudgetStatus,
    enum: true
  ...
  field :pending_proposal, 22,
    type: Google.Ads.Googleads.V7.Resources.AccountBudget.PendingAccountBudgetProposal
