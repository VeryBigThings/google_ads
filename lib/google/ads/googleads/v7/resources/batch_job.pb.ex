defmodule Google.Ads.Googleads.V7.Resources.BatchJob.BatchJobMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Resources.BatchJob do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          metadata: Google.Ads.Googleads.V7.Resources.BatchJob.BatchJobMetadata.t() | nil,
          status: Google.Ads.Googleads.V7.Enums.BatchJobStatusEnum.BatchJobStatus.t(),
  ...
  field :metadata, 4, type: Google.Ads.Googleads.V7.Resources.BatchJob.BatchJobMetadata

  field :status, 5,
    type: Google.Ads.Googleads.V7.Enums.BatchJobStatusEnum.BatchJobStatus,
    enum: true
