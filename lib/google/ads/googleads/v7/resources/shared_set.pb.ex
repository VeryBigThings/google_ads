defmodule Google.Ads.Googleads.V7.Resources.SharedSet do
  @moduledoc false
  ...
  field :type, 3, type: Google.Ads.Googleads.V7.Enums.SharedSetTypeEnum.SharedSetType, enum: true
  field :name, 9, type: :string

  field :status, 5,
    type: Google.Ads.Googleads.V7.Enums.SharedSetStatusEnum.SharedSetStatus,
    enum: true
