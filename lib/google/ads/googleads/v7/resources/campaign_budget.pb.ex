defmodule Google.Ads.Googleads.V7.Resources.CampaignBudget do
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V7.Enums.BudgetStatusEnum.BudgetStatus.t(),
          delivery_method:
            Google.Ads.Googleads.V7.Enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod.t(),
          explicitly_shared: boolean,
          reference_count: integer,
          has_recommended_budget: boolean,
          recommended_budget_amount_micros: integer,
          period: Google.Ads.Googleads.V7.Enums.BudgetPeriodEnum.BudgetPeriod.t(),
          ...
          type: Google.Ads.Googleads.V7.Enums.BudgetTypeEnum.BudgetType.t()
        }
  defstruct [
    :resource_name,
    :id,
