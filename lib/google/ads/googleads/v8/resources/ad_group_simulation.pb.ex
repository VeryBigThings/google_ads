defmodule Google.Ads.Googleads.V8.Resources.AdGroupSimulation do
  ...
  field :ad_group_id, 12, type: Google.Protobuf.Int64Value
  ...
  field :start_date, 13, type: Google.Protobuf.StringValue
  field :end_date, 14, type: Google.Protobuf.StringValue
