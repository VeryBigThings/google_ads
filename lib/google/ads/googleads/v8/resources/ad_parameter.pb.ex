defmodule Google.Ads.Googleads.V8.Resources.AdParameter do
  ...
  field :ad_group_criterion, 5, type: Google.Protobuf.StringValue
  field :parameter_index, 6, type: Google.Protobuf.Int64Value
  field :insertion_text, 7, type: Google.Protobuf.StringValue
end
