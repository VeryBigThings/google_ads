defmodule Google.Ads.Googleads.V8.Resources.AdGroupBidModifier do
  ...
  field :ad_group, 13, type: Google.Protobuf.StringValue
  field :criterion_id, 14, type: Google.Protobuf.Int64Value
  field :bid_modifier, 15, type: Google.Protobuf.DoubleValue
  field :base_ad_group, 16, type: Google.Protobuf.StringValue
