defmodule Google.Ads.Googleads.V8.Resources.ExtensionFeedItem do
  ...
  field :start_date_time, 26, type: Google.Protobuf.StringValue
  field :end_date_time, 27, type: Google.Protobuf.StringValue
  ...
  field :targeted_geo_target_constant, 30, type: Google.Protobuf.StringValue
  field :targeted_keyword, 22, type: Google.Ads.Googleads.V8.Common.KeywordInfo

  field :status, 4,
    type: Google.Ads.Googleads.V8.Enums.FeedItemStatusEnum.FeedItemStatus,
    enum: true

  field :sitelink_feed_item, 2, type: Google.Ads.Googleads.V8.Common.SitelinkFeedItem, oneof: 0

  field :structured_snippet_feed_item, 3,
    type: Google.Ads.Googleads.V8.Common.StructuredSnippetFeedItem,
    oneof: 0

  field :app_feed_item, 7, type: Google.Ads.Googleads.V8.Common.AppFeedItem, oneof: 0
  field :call_feed_item, 8, type: Google.Ads.Googleads.V8.Common.CallFeedItem, oneof: 0
  field :callout_feed_item, 9, type: Google.Ads.Googleads.V8.Common.CalloutFeedItem, oneof: 0

  field :text_message_feed_item, 10,
    type: Google.Ads.Googleads.V8.Common.TextMessageFeedItem,
    oneof: 0

  field :price_feed_item, 11, type: Google.Ads.Googleads.V8.Common.PriceFeedItem, oneof: 0
  field :promotion_feed_item, 12, type: Google.Ads.Googleads.V8.Common.PromotionFeedItem, oneof: 0
  field :location_feed_item, 14, type: Google.Ads.Googleads.V8.Common.LocationFeedItem, oneof: 0
  ...
  field :image_feed_item, 31, type: Google.Ads.Googleads.V8.Common.ImageFeedItem, oneof: 0
