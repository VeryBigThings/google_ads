defmodule Google.Ads.Googleads.V8.Resources.AccountBudgetProposal do
  ...
  field :account_budget, 27, type: Google.Protobuf.StringValue
  ...
  field :proposed_name, 28, type: Google.Protobuf.StringValue
  field :approved_start_date_time, 30, type: Google.Protobuf.StringValue
  field :proposed_purchase_order_number, 35, type: Google.Protobuf.StringValue
  field :proposed_notes, 36, type: Google.Protobuf.StringValue
  field :creation_date_time, 37, type: Google.Protobuf.StringValue
  field :approval_date_time, 38, type: Google.Protobuf.StringValue
