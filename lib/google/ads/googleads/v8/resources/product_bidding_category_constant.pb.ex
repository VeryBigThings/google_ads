defmodule Google.Ads.Googleads.V8.Resources.ProductBiddingCategoryConstant do
  ...
  field :product_bidding_category_constant_parent, 12, type: Google.Protobuf.StringValue
  ...
  field :language_code, 13, type: Google.Protobuf.StringValue
  field :localized_name, 14, type: Google.Protobuf.StringValue
end
