defmodule Google.Ads.Googleads.V8.Resources.PaymentsAccount do
  ...
  field :payments_account_id, 8, type: Google.Protobuf.StringValue
  field :name, 9, type: Google.Protobuf.StringValue
  field :currency_code, 10, type: Google.Protobuf.StringValue
  field :payments_profile_id, 11, type: Google.Protobuf.StringValue
  field :secondary_payments_profile_id, 12, type: Google.Protobuf.StringValue
  field :paying_manager_customer, 13, type: Google.Protobuf.StringValue
end
