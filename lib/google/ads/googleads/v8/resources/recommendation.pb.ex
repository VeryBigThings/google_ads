...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.RecommendationMetrics do
  ...
  field :impressions, 6, type: Google.Protobuf.DoubleValue
  field :clicks, 7, type: Google.Protobuf.DoubleValue
  field :cost_micros, 8, type: Google.Protobuf.Int64Value
  field :conversions, 9, type: Google.Protobuf.DoubleValue
  field :video_views, 10, type: Google.Protobuf.DoubleValue
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption do
  ...
  field :budget_amount_micros, 3, type: Google.Protobuf.Int64Value
  field :impact, 2, type: Google.Ads.Googleads.V8.Resources.Recommendation.RecommendationImpact
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.CampaignBudgetRecommendation do
  ...
  field :current_budget_amount_micros, 7, type: Google.Protobuf.Int64Value
  field :recommended_budget_amount_micros, 8, type: Google.Protobuf.Int64Value
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.KeywordRecommendation do
  ...
  field :keyword, 1, type: Google.Ads.Googleads.V8.Common.KeywordInfo
  field :recommended_cpc_bid_micros, 3, type: Google.Protobuf.Int64Value
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.TextAdRecommendation do
  ...
  field :creation_date, 4, type: Google.Protobuf.StringValue
  field :auto_apply_date, 5, type: Google.Protobuf.StringValue
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption do
  ...
  field :target_cpa_micros, 5, type: Google.Protobuf.Int64Value
  field :required_campaign_budget_amount_micros, 6, type: Google.Protobuf.Int64Value
  field :impact, 4, type: Google.Ads.Googleads.V8.Resources.Recommendation.RecommendationImpact
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.TargetCpaOptInRecommendation do
  ...
  field :recommended_target_cpa_micros, 3, type: Google.Protobuf.Int64Value
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.TargetRoasOptInRecommendation do
  ...
  @type t :: %__MODULE__{
          recommended_target_roas: Google.Protobuf.DoubleValue.t() | nil,
          required_campaign_budget_amount_micros: Google.Protobuf.Int64Value.t() | nil
        }

  defstruct [:recommended_target_roas, :required_campaign_budget_amount_micros]

  field :recommended_target_roas, 1, type: Google.Protobuf.DoubleValue
  field :required_campaign_budget_amount_micros, 2, type: Google.Protobuf.Int64Value
end
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation.MoveUnusedBudgetRecommendation do
  ...
  field :excess_campaign_budget, 3, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Resources.Recommendation do
  ...
  field :impact, 3, type: Google.Ads.Googleads.V8.Resources.Recommendation.RecommendationImpact
  field :campaign_budget, 24, type: Google.Protobuf.StringValue
  field :campaign, 25, type: Google.Protobuf.StringValue
  field :ad_group, 26, type: Google.Protobuf.StringValue
  field :dismissed, 27, type: Google.Protobuf.BoolValue
