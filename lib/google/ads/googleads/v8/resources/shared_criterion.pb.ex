defmodule Google.Ads.Googleads.V8.Resources.SharedCriterion do
  ...
  field :shared_set, 10, type: Google.Protobuf.StringValue
  field :criterion_id, 11, type: Google.Protobuf.Int64Value
  field :type, 4, type: Google.Ads.Googleads.V8.Enums.CriterionTypeEnum.CriterionType, enum: true
  field :keyword, 3, type: Google.Ads.Googleads.V8.Common.KeywordInfo, oneof: 0
  field :youtube_video, 5, type: Google.Ads.Googleads.V8.Common.YouTubeVideoInfo, oneof: 0
  field :youtube_channel, 6, type: Google.Ads.Googleads.V8.Common.YouTubeChannelInfo, oneof: 0
