defmodule Google.Ads.Googleads.V8.Resources.CampaignCriterion do
  ...
  field :campaign, 37, type: Google.Protobuf.StringValue
  field :criterion_id, 38, type: Google.Protobuf.Int64Value
  field :display_name, 43, type: :string
  field :bid_modifier, 39, type: Google.Protobuf.FloatValue
  field :negative, 40, type: Google.Protobuf.BoolValue
