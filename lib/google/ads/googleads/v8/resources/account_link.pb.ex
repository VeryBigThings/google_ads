defmodule Google.Ads.Googleads.V8.Resources.AccountLink do
  ...
  field :google_ads, 7,
    optional: true,
    type: Google.Ads.Googleads.V8.Resources.GoogleAdsLinkIdentifier,
    oneof: 0
end
...
defmodule Google.Ads.Googleads.V8.Resources.ThirdPartyAppAnalyticsLinkIdentifier do
  ...
  field :app_analytics_provider_id, 4, optional: true, type: :int64
  field :app_id, 5, optional: true, type: :string
...
defmodule Google.Ads.Googleads.V8.Resources.DataPartnerLinkIdentifier do
  ...
  field :data_partner_id, 1, optional: true, type: :int64
end
...
defmodule Google.Ads.Googleads.V8.Resources.GoogleAdsLinkIdentifier do
  ...
  field :customer, 3, optional: true, type: :string
end
