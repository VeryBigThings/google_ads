defmodule Google.Ads.Googleads.V8.Resources.FeedItemTarget do
  ...
  field :feed_item, 12, type: Google.Protobuf.StringValue

  field :feed_item_target_type, 3,
    type: Google.Ads.Googleads.V8.Enums.FeedItemTargetTypeEnum.FeedItemTargetType,
    enum: true

  field :feed_item_target_id, 13, type: Google.Protobuf.Int64Value
  ...
  field :keyword, 7, type: Google.Ads.Googleads.V8.Common.KeywordInfo, oneof: 0
  ...
  field :ad_schedule, 10, type: Google.Ads.Googleads.V8.Common.AdScheduleInfo, oneof: 0
end
