defmodule Google.Ads.Googleads.V8.Resources.KeywordPlanAdGroupKeyword do
  ...
  field :keyword_plan_ad_group, 8, type: Google.Protobuf.StringValue
  field :id, 9, type: Google.Protobuf.Int64Value
  field :text, 10, type: Google.Protobuf.StringValue

  field :match_type, 5,
    type: Google.Ads.Googleads.V8.Enums.KeywordMatchTypeEnum.KeywordMatchType,
    enum: true

  field :cpc_bid_micros, 11, type: Google.Protobuf.Int64Value
  field :negative, 12, type: Google.Protobuf.BoolValue
end
