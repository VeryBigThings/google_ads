...
defmodule Google.Ads.Googleads.V8.Resources.ConversionAction.ValueSettings do
  ...
  field :default_value, 4, type: Google.Protobuf.DoubleValue
  field :default_currency_code, 5, type: Google.Protobuf.StringValue
  field :always_use_default_value, 6, type: Google.Protobuf.BoolValue
end
...
defmodule Google.Ads.Googleads.V8.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings do
  ...
  field :event_name, 2, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Resources.ConversionAction.FirebaseSettings do
  ...
  field :event_name, 3, type: Google.Protobuf.StringValue
  field :project_id, 4, type: Google.Protobuf.StringValue
end
...
defmodule Google.Ads.Googleads.V8.Resources.ConversionAction do
  ...
  field :id, 21, type: Google.Protobuf.Int64Value
  field :name, 22, type: Google.Protobuf.StringValue
  ...
  field :owner_customer, 23, type: Google.Protobuf.StringValue
  field :include_in_conversions_metric, 24, type: Google.Protobuf.BoolValue
  field :click_through_lookback_window_days, 25, type: Google.Protobuf.Int64Value
  field :view_through_lookback_window_days, 26, type: Google.Protobuf.Int64Value
  ...
  field :phone_call_duration_seconds, 27, type: Google.Protobuf.Int64Value
  field :app_id, 28, type: Google.Protobuf.StringValue
