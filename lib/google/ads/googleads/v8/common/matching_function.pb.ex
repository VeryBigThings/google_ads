defmodule Google.Ads.Googleads.V8.Common.MatchingFunction do
  ...
  field :function_string, 5, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Common.Operand.FeedAttributeOperand do
  ...
  field :feed_id, 3, type: Google.Protobuf.Int64Value
  field :feed_attribute_id, 4, type: Google.Protobuf.Int64Value
end
