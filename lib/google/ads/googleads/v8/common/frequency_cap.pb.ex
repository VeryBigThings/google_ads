defmodule Google.Ads.Googleads.V8.Common.FrequencyCapEntry do
  ...
  field :key, 1, type: Google.Ads.Googleads.V8.Common.FrequencyCapKey
  field :cap, 3, type: Google.Protobuf.Int32Value
end
...
defmodule Google.Ads.Googleads.V8.Common.FrequencyCapKey do
  ...
  field :time_length, 5, type: Google.Protobuf.Int32Value
end
