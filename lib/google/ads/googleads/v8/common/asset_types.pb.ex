...
defmodule Google.Ads.Googleads.V8.Common.MediaBundleAsset do
  ...
  field :data, 2, type: Google.Protobuf.BytesValue
end
...
defmodule Google.Ads.Googleads.V8.Common.ImageAsset do
  ...
  field :data, 5, type: Google.Protobuf.BytesValue
  field :file_size, 6, type: Google.Protobuf.Int64Value
...
defmodule Google.Ads.Googleads.V8.Common.ImageDimension do
  ...
  field :height_pixels, 4, type: Google.Protobuf.Int64Value
  field :width_pixels, 5, type: Google.Protobuf.Int64Value
  field :url, 6, type: Google.Protobuf.StringValue
end
...
defmodule Google.Ads.Googleads.V8.Common.LeadFormAsset do
  ...
  @type t :: %__MODULE__{
          ...
          post_submit_headline: Google.Protobuf.StringValue.t() | nil,
          post_submit_description: Google.Protobuf.StringValue.t() | nil,
          ...
          background_image_asset: Google.Protobuf.StringValue.t() | nil,
          desired_intent:
            Google.Ads.Googleads.V8.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent.t(),
          custom_disclosure: Google.Protobuf.StringValue.t() | nil
        }
  ...
  field :post_submit_headline, 15, type: Google.Protobuf.StringValue
  field :post_submit_description, 16, type: Google.Protobuf.StringValue
  ...
  field :background_image_asset, 20, type: Google.Protobuf.StringValue

  field :desired_intent, 21,
    type: Google.Ads.Googleads.V8.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
    enum: true

  field :custom_disclosure, 22, type: Google.Protobuf.StringValue
end
...
defmodule Google.Ads.Googleads.V8.Common.WebhookDelivery do
  ...
  @type t :: %__MODULE__{
          advertiser_webhook_url: Google.Protobuf.StringValue.t() | nil,
          google_secret: Google.Protobuf.StringValue.t() | nil,
          payload_schema_version: Google.Protobuf.Int64Value.t() | nil
        }

  defstruct [:advertiser_webhook_url, :google_secret, :payload_schema_version]

  field :advertiser_webhook_url, 4, type: Google.Protobuf.StringValue
  field :google_secret, 5, type: Google.Protobuf.StringValue
  field :payload_schema_version, 6, type: Google.Protobuf.Int64Value
end
