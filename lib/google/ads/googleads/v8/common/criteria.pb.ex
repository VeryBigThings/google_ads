...
defmodule Google.Ads.Googleads.V8.Common.MobileAppCategoryInfo do
  ...
  field :mobile_app_category_constant, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.ListingGroupInfo do
  ...
  field :case_value, 2, optional: true, type: Google.Ads.Googleads.V8.Common.ListingDimensionInfo
  field :parent_ad_group_criterion, 4, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.ListingDimensionInfo do
  ...
  oneof :dimension, 0
  field :hotel_id, 2, optional: true, type: Google.Ads.Googleads.V8.Common.HotelIdInfo, oneof: 0

  field :hotel_class, 3,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.HotelClassInfo,
    oneof: 0
  ...
  field :hotel_state, 5,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.HotelStateInfo,
    oneof: 0

  field :hotel_city, 6,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.HotelCityInfo,
    oneof: 0
  ...
  field :product_brand, 15,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.ProductBrandInfo,
    oneof: 0

  field :product_channel, 8,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.ProductChannelInfo,
    oneof: 0
  ...
  field :product_item_id, 11,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.ProductItemIdInfo,
    oneof: 0

  field :product_type, 12,
    optional: true,
    type: Google.Ads.Googleads.V8.Common.ProductTypeInfo,
    oneof: 0
...
defmodule Google.Ads.Googleads.V8.Common.HotelCountryRegionInfo do
  ...
  field :country_region_criterion, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.HotelStateInfo do
  ...
  field :state_criterion, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.HotelCityInfo do
  ...
  field :city_criterion, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.ProductBiddingCategoryInfo do
  ...
  field :id, 4, optional: true, type: :int64
  field :country_code, 5, optional: true, type: :string
...
defmodule Google.Ads.Googleads.V8.Common.HotelAdvanceBookingWindowInfo do
  ...
  field :min_days, 3, optional: true, type: :int64
  field :max_days, 4, optional: true, type: :int64
end
...
defmodule Google.Ads.Googleads.V8.Common.HotelLengthOfStayInfo do
  ...
  field :min_nights, 3, optional: true, type: :int64
  field :max_nights, 4, optional: true, type: :int64
end
...
defmodule Google.Ads.Googleads.V8.Common.HotelCheckInDateRangeInfo do
  ...
  field :end_date, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.AdScheduleInfo do
  ...
  field :start_hour, 6, optional: true, type: :int32
  field :end_hour, 7, optional: true, type: :int32
...
defmodule Google.Ads.Googleads.V8.Common.YouTubeVideoInfo do
  ...
  field :video_id, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.YouTubeChannelInfo do
  ...
  field :channel_id, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.ProximityInfo do
  ...
  field :geo_point, 1, optional: true, type: Google.Ads.Googleads.V8.Common.GeoPointInfo
  field :radius, 5, optional: true, type: :double
  ...
  field :address, 4, optional: true, type: Google.Ads.Googleads.V8.Common.AddressInfo
end
...
defmodule Google.Ads.Googleads.V8.Common.GeoPointInfo do
  ...
  field :longitude_in_micro_degrees, 3, optional: true, type: :int32
  field :latitude_in_micro_degrees, 4, optional: true, type: :int32
end
...
defmodule Google.Ads.Googleads.V8.Common.AddressInfo do
  ...
  field :postal_code, 8, optional: true, type: :string
  field :province_code, 9, optional: true, type: :string
  field :country_code, 10, optional: true, type: :string
  field :province_name, 11, optional: true, type: :string
  field :street_address, 12, optional: true, type: :string
  field :street_address2, 13, optional: true, type: :string
  field :city_name, 14, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.TopicInfo do
  ...
  field :topic_constant, 3, optional: true, type: :string
...
defmodule Google.Ads.Googleads.V8.Common.LanguageInfo do
  ...
  field :language_constant, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.CarrierInfo do
  ...
  field :carrier_constant, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.UserInterestInfo do
  ...
  field :user_interest_category, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.WebpageInfo do
  ...
  field :criterion_name, 3, optional: true, type: :string
  field :conditions, 2, repeated: true, type: Google.Ads.Googleads.V8.Common.WebpageConditionInfo
  field :coverage_percentage, 4, optional: true, type: :double
  field :sample, 5, optional: true, type: Google.Ads.Googleads.V8.Common.WebpageSampleInfo
end
...
defmodule Google.Ads.Googleads.V8.Common.WebpageConditionInfo do
  ...
  field :argument, 4, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.OperatingSystemVersionInfo do
  ...
  field :operating_system_version_constant, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.MobileDeviceInfo do
  ...
  field :mobile_device_constant, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.CustomAffinityInfo do
  ...
  field :custom_affinity, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.CustomIntentInfo do
  ...
  field :custom_intent, 2, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.LocationGroupInfo do
  ...
  field :feed, 5, optional: true, type: :string
  field :geo_target_constants, 6, repeated: true, type: :string
  field :radius, 7, optional: true, type: :int64
...
defmodule Google.Ads.Googleads.V8.Common.CustomAudienceInfo do
  ...
  field :custom_audience, 1, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.CombinedAudienceInfo do
  ...
  field :combined_audience, 1, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Common.KeywordThemeInfo do
  ...
  field :keyword_theme_constant, 1, optional: true, type: :string, oneof: 0
  field :free_form_keyword_theme, 2, optional: true, type: :string, oneof: 0
end
