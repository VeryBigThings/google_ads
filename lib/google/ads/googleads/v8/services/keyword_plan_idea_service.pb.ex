defmodule Google.Ads.Googleads.V8.Services.GenerateKeywordIdeasRequest do
  ...
  field :language, 14, type: Google.Protobuf.StringValue
  ...
  field :aggregate_metrics, 16, type: Google.Ads.Googleads.V8.Common.KeywordPlanAggregateMetrics
  ...
  field :keyword_seed, 3, type: Google.Ads.Googleads.V8.Services.KeywordSeed, oneof: 0
  field :url_seed, 5, type: Google.Ads.Googleads.V8.Services.UrlSeed, oneof: 0
  field :site_seed, 11, type: Google.Ads.Googleads.V8.Services.SiteSeed, oneof: 0
end
...
defmodule Google.Ads.Googleads.V8.Services.SiteSeed do
  ...
  field :site, 2, type: Google.Protobuf.StringValue
end
...
defmodule Google.Ads.Googleads.V8.Services.GenerateKeywordIdeaResult do
  ...
  field :keyword_annotations, 6, type: Google.Ads.Googleads.V8.Common.KeywordAnnotations
end
