...
defmodule Google.Ads.Googleads.V8.Services.ClickConversion do
  ...
  field :gclid, 9, optional: true, type: :string
  field :conversion_action, 10, optional: true, type: :string
  field :conversion_date_time, 11, optional: true, type: :string
  field :conversion_value, 12, optional: true, type: :double
  field :currency_code, 13, optional: true, type: :string
  field :order_id, 14, optional: true, type: :string
  ...
  field :cart_data, 16, optional: true, type: Google.Ads.Googleads.V8.Services.CartData
end
...
defmodule Google.Ads.Googleads.V8.Services.CallConversion do
  ...
  field :caller_id, 7, optional: true, type: :string
  field :call_start_date_time, 8, optional: true, type: :string
  field :conversion_action, 9, optional: true, type: :string
  field :conversion_date_time, 10, optional: true, type: :string
  field :conversion_value, 11, optional: true, type: :double
  field :currency_code, 12, optional: true, type: :string
...
defmodule Google.Ads.Googleads.V8.Services.ExternalAttributionData do
  ...
  field :external_attribution_credit, 3, optional: true, type: :double
  field :external_attribution_model, 4, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Services.ClickConversionResult do
  ...
  field :gclid, 4, optional: true, type: :string
  field :conversion_action, 5, optional: true, type: :string
  field :conversion_date_time, 6, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Services.CallConversionResult do
  ...
  field :caller_id, 5, optional: true, type: :string
  field :call_start_date_time, 6, optional: true, type: :string
  field :conversion_action, 7, optional: true, type: :string
  field :conversion_date_time, 8, optional: true, type: :string
end
...
defmodule Google.Ads.Googleads.V8.Services.CustomVariable do
  ...
  field :conversion_custom_variable, 1, optional: true, type: :string
...
defmodule Google.Ads.Googleads.V8.Services.CartData.Item do
  ...
  field :product_id, 1, optional: true, type: :string
  field :quantity, 2, optional: true, type: :int32
  field :unit_price, 3, optional: true, type: :double
end
...
defmodule Google.Ads.Googleads.V8.Services.CartData do
  ...
  field :merchant_id, 1, optional: true, type: :string
  field :feed_country_code, 2, optional: true, type: :string
  field :feed_language_code, 3, optional: true, type: :string
  field :local_transaction_cost, 4, optional: true, type: :double
