...
defmodule Google.Ads.Googleads.V8.Services.KeywordPlanCampaignForecast do
  ...
  field :keyword_plan_campaign, 3, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Services.KeywordPlanAdGroupForecast do
  ...
  field :keyword_plan_ad_group, 3, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Services.KeywordPlanKeywordForecast do
  ...
  field :keyword_plan_ad_group_keyword, 3, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Services.KeywordPlanMaxCpcBidForecast do
  ...
  field :max_cpc_bid_micros, 3, type: Google.Protobuf.Int64Value
...
defmodule Google.Ads.Googleads.V8.Services.ForecastMetrics do
  ...
  field :impressions, 7, type: Google.Protobuf.DoubleValue
  field :ctr, 8, type: Google.Protobuf.DoubleValue
  field :average_cpc, 9, type: Google.Protobuf.Int64Value
  field :clicks, 10, type: Google.Protobuf.DoubleValue
  field :cost_micros, 11, type: Google.Protobuf.Int64Value
end
...
defmodule Google.Ads.Googleads.V8.Services.KeywordPlanKeywordHistoricalMetrics do
  ...
  field :search_query, 4, type: Google.Protobuf.StringValue
