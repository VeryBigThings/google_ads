...
defmodule Google.Ads.Googleads.V8.Services.ConversionAdjustment do
  ...
  field :conversion_action, 8, type: Google.Protobuf.StringValue
  field :adjustment_date_time, 9, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Services.RestatementValue do
  ...
  field :adjusted_value, 3, type: Google.Protobuf.DoubleValue
...
defmodule Google.Ads.Googleads.V8.Services.GclidDateTimePair do
  ...
  field :gclid, 3, type: Google.Protobuf.StringValue
...
defmodule Google.Ads.Googleads.V8.Services.ConversionAdjustmentResult do
  ...
  field :adjustment_date_time, 8, type: Google.Protobuf.StringValue
