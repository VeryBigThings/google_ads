...
defmodule Google.Ads.Googleads.V8.Services.ClickConversion do
  ...
  field :user_identifiers, 17, repeated: true, type: Google.Ads.Googleads.V8.Common.UserIdentifier
end
...
defmodule Google.Ads.Googleads.V8.Services.ClickConversionResult do
  ...
  defstruct [:gclid, :conversion_action, :conversion_date_time, :user_identifiers]

  field :gclid, 4, type: :string
  field :conversion_action, 5, type: :string
  field :conversion_date_time, 6, type: :string
  field :user_identifiers, 7, repeated: true, type: Google.Ads.Googleads.V8.Common.UserIdentifier
end
